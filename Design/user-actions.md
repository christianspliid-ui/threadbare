...
**Last updated:** 2026-09-20 15:00 local (2026-09-20 13:00 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Board read live this run.
...
**The ask: say "design THR-1479" in a chat.** As of 20 September 15:00 the board holds nothing ready and nothing in progress for the second day running, and the last work finished 28 hours ago. The 26 Todo items cannot fill it: nine are design tickets whose bodies forbid promotion, fifteen are wayfinder tickets that never enter the queue.
