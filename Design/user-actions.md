...
**Last updated:** 2026-08-28 08:57 local (06:57 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
**As of 08:31 there is no new feature work queued at all.** Your [shared-anchor design](https://linear.app/threadbare/issue/THR-1212) finished whole this morning — six slices, all merged and deployed — and the builder immediately claimed [hunger vocabulary](https://linear.app/threadbare/issue/THR-1213), your other design, shipping its first slice by 08:40. **Both of the jobs your designs supplied are now spent.** The seven jobs still queued behind them are small follow-ups the anchor-machinery and action-library builds filed on themselves as they finished — real work, all of it cleanup, none of it new. That is what the blocked design column costs, expressed in jobs rather than in days.
