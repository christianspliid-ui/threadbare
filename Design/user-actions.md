...
**Last updated:** 2026-08-15 15:56 local (2026-08-15 13:56 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
**Changed since you looked — every visible finding is now live.** #1 (no links to any reward/penalty attachment) shipped as [THR-1120](https://linear.app/threadbare/issue/THR-1120/consequence-chips-name-their-rewardpenalty-attachment-but-never-link); #2 and #3 (the legacy stance purchases) shipped as [THR-1121](https://linear.app/threadbare/issue/THR-1121), with the last quest encounter carrying that triple cleared in [THR-1123](https://linear.app/threadbare/issue/THR-1123); and as of 15:26 the resolution readout no longer prints raw percentages at you ([THR-1124](https://linear.app/threadbare/issue/THR-1124), [PR #1479](https://github.com/christianspliid-ui/threadbare/pull/1479)). #4 is on the [THR-1043](https://linear.app/threadbare/issue/THR-1043) retrofit list and needs nothing from you.
...
- 2026-08-15: **the main working copy is syncing again.** [THR-1119](https://linear.app/threadbare/issue/THR-1119) — after 14 consecutive hourly refusals and 27 commits of drift, the three blocking edits were triaged and the tree fast-forwarded cleanly. Confirmed still healthy at 15:50.
