...
**Last updated:** 2026-08-28 07:35 local (05:35 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
**The shelf looks healthier than it is.** Six jobs are queued, but five of them are small follow-ups the last two builds filed on themselves as they finished; **[hunger vocabulary](https://linear.app/threadbare/issue/THR-1213) is the only new feature work on it.** When the builder reaches it, the shelf is cleanup only — which is what the blocked design column actually costs, expressed in jobs rather than in days.
