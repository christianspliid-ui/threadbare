...
**Last updated:** 2026-09-12 18:57 local (16:57 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Board read live this run.

## Standing asks

### Finish the sitting — two encounters left ([THR-1220](https://linear.app/threadbare/issue/THR-1220))

You stopped after four feedback batches this morning with *"more batches expected."* Everything those batches produced is shipped, merged and live — chip nouns, chip sentences, the promise rule, the condition hover, the nudge-stage rebuild ([THR-1478](https://linear.app/threadbare/issue/THR-1478)) and the shared detail card ([THR-1490](https://linear.app/threadbare/issue/THR-1490)), which has now finished publishing. Nothing you flagged is still waiting on a build, and no hard-refresh is needed.

- [The Unsafe Bridge](https://threadbearer.co/?view=game&seeded&size=medium&spawn=encounter.slice.unsafe_bridge)
- [Riders Behind the Caravan](https://threadbearer.co/?view=game&seeded&size=medium&spawn=encounter.slice.riders_behind_caravan)

The one question: **is the integrated encounter experience at an acceptable state?** A pass charters the hub map. Two things on those screens are already decided and are not asks — the die replacing the tier word where a written law says otherwise (recorded, overrule on sight), and two factor lines that are not sentences ([THR-1494](https://linear.app/threadbare/issue/THR-1494), queued).
...
- **2026-09-12 — content opens the codex; the veto is yours on sight** ([THR-1491](https://linear.app/threadbare/issue/THR-1491)). Decided by the lane, not queued on you: clicking an encounter template, item or condition opens the codex as its full page. It is the *how* of an agreed design, so it ships unless you overrule it.
- **2026-09-12 — every kind of thing opens the same card** ([THR-1490](https://linear.app/threadbare/issue/THR-1490)). Merged 17:54, live 18:5x. A name anywhere in the game opens the same sheet.
- **2026-09-12 — the content-object registry is merged** ([THR-1485](https://linear.app/threadbare/issue/THR-1485)). Merged 16:30. Infrastructure for "any content can hand out any other content, by tag" — nothing visible to you yet.
- **2026-09-12 — the nudge stage is one block, and it is live** ([THR-1478](https://linear.app/threadbare/issue/THR-1478)). Merged 15:44. Your batch-4 redesign: two panels became one, the forecast a die, the difficulty a tilting balance, the objective line gone.
