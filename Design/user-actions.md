...
**Last updated:** 2026-08-15 14:05 local (2026-08-15 12:05 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
**Changed since you looked — both visible findings are now live.** #1 (no links to any reward/penalty attachment) shipped as [THR-1120](https://linear.app/threadbare/issue/THR-1120/consequence-chips-name-their-rewardpenalty-attachment-but-never-link); #2 and #3 (the legacy stance purchases) shipped as [THR-1121](https://linear.app/threadbare/issue/THR-1121), and the last quest encounter carrying that triple merged this hour ([THR-1123](https://linear.app/threadbare/issue/THR-1123)). #4 is on the [THR-1043](https://linear.app/threadbare/issue/THR-1043) retrofit list and needs nothing from you.
...
- 2026-08-15: **the glossary can now say a word was rejected.** [THR-991](https://linear.app/threadbare/issue/THR-991) ([PR #1464](https://github.com/christianspliid-ui/threadbare/pull/1464)) — previously the only way to record a term we turned down was to mislabel it "deprecated".
