...
**Last updated:** 2026-08-13 23:54 local (2026-08-13 21:54 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
- 2026-08-13: **the mad-lib encounters started getting written.** The seven story-beat templates — the climactic, `deadly`-rated beats of their families — were authored out of the `{adj}`/`{verb}`/`{noun}` shape into real prose ([THR-1101](https://linear.app/threadbare/issue/THR-1101), [PR #1434](https://github.com/christianspliid-ui/threadbare/pull/1434)), the twelfth merge to `main` that day. Batch 1 of a campaign: 146 templates still carry the shape, and the ticket stays open for them.
