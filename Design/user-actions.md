...
**Last updated:** 2026-09-23 15:58 local (13:58 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Board read live this run.

## Standing asks

### One design hour: are scenes being offered to exactly the people who will refuse them?

[THR-1525](https://linear.app/threadbare/issue/THR-1525/signed-desire-score-vs-the-specs-step-6-a-fork-that-plants-on-its), on the design desk since 06:37 local on 21 September. **The builder's last job (a process fix, THR-1529) is still waiting on a docs-check repair. After that its shelf is empty, and this item is what holds up the next design being staged.**
