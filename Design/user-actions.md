...
**Last updated:** 2026-09-10 07:57 local (2026-09-10 05:57 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Board read live this run.

## Standing asks

### 1. Rule on the backlog — one sitting, smallest first

**This is why the queue keeps emptying, and it is now empty.** The builder shipped its last job at 05:20Z and has nothing left. The backlog is forty items deep — every one waiting on a ruling from you, not on effort. Roughly fourteen are one- and two-sentence answers, each releasing buildable work. Named so far:
...
- [The consequence draw can deal a hand no authored content can wire](https://linear.app/threadbare/issue/THR-1446) — the author burns their one swap fighting the engine instead of the fiction.
...
### 2. Is holding a town a commitment or a possession? — [THR-1287](https://linear.app/threadbare/issue/THR-1287/control-upkeep-is-structurally-impossible-nothing-ever-resets)

**New this run, and the readiest thing on the list.** A design session wrote the entire plan on Tuesday evening and stopped on this one fork.

Right now a mortal who claims a town loses it on a fixed timer and can do **nothing whatsoever** to keep it — no action renews the hold — while the game tells the player *"a grip you stop renewing slowly opens"*. So it has to become one of two things:
...
**Recommendation: commitment.** What a mortal founds or buys, they own; what they merely claim, they must keep holding — which is what the undertaking grid, the strategic prose and the wiki all currently say. The other side has a real case: an earlier ruling of yours ([THR-1280](https://linear.app/threadbare/issue/THR-1280)) removed upkeep in favour of ownership-by-attachment, and that shipped as **Freehold**. The review caught the clash and stopped rather than pick for you. One word releases a finished plan the same day and frees a design slot.

### 3. Batch 2 — sample the two, say whether they are worth meeting twice — [THR-1130](https://linear.app/threadbare/issue/THR-1130/encounter-factory-pilot-volume-retrofit-the-15-nudge-era-encounters-to)
...
Yes releases batch 3. Anything short of yes is feedback the line can act on. [Batch report](https://github.com/christianspliid-ui/threadbare/blob/main/Docs/plans/encounters/batch-report-2026-09-09.md). This is the only parked job on the board.

### 4. The screenshot sweep is unstuck and wants an attended hour — [THR-1133](https://linear.app/threadbare/issue/THR-1133/attended-pixel-pass-sweep-five-owed-19201080-captures-one-dev-server)
...
### 9. Are you still planning to design Traits wave 2? — [THR-790](https://linear.app/threadbare/issue/THR-790/traits-wave-2-locations-artifacts-and-draw-by-trait-pools)
...
- **2026-09-10 — the builder's last job shipped, and the shelf is now empty.** [THR-1443](https://linear.app/threadbare/issue/THR-1443) is Done at 05:20Z ([PR #1871](https://github.com/christianspliid-ui/threadbare/pull/1871)) — the session start-up check now notices when the issue board itself cannot be read, instead of four lanes each rediscovering an outage on their own. Claimed and merged in seventeen minutes.
...
- **2026-09-09 — batch 2 is built.** [THR-1222](https://linear.app/threadbare/issue/THR-1222) is Done; six encounters composition-complete, gate green 6/6, live-proved 6/6, 37 warnings → 0 ([PR #1864](https://github.com/christianspliid-ui/threadbare/pull/1864)). Only your two-encounter verdict remains, and it is ask 3 above.
