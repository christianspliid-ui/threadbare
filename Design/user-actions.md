...
**Last updated:** 2026-09-16 20:53 local (18:53 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Board read live this run.
...
**The ask: say "design THR-1448" in a chat.** The build queue holds seven Low-priority repairs and nothing above them.
