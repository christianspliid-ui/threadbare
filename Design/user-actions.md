...
**Last updated:** 2026-08-13 21:58 local (2026-08-13 19:58 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
- 2026-08-13: **an eighth demo-path fix shipped without you.** The prose abstraction detector stopped gating and started ranking ([THR-1092](https://linear.app/threadbare/issue/THR-1092), [PR #1432](https://github.com/christianspliid-ui/threadbare/pull/1432)) — the tenth merge to `main` that day.
