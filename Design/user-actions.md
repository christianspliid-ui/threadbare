...
**Last updated:** 2026-08-14 01:57 local (2026-08-13 23:57 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
- 2026-08-14: **the mad-lib encounters are getting written, three families deep.** Batch 1 authored the seven `deadly`-rated story beats; batch 2 drained the **duel** family (10 templates, 82 lines); batch 3 drained the **build** family (16 templates, 123 token lines) ([THR-1101](https://linear.app/threadbare/issue/THR-1101), PRs [#1434](https://github.com/christianspliid-ui/threadbare/pull/1434), [#1435](https://github.com/christianspliid-ui/threadbare/pull/1435), [#1436](https://github.com/christianspliid-ui/threadbare/pull/1436)). Batch 3's finding: a family's token count does not size its authoring load — nine of its sixteen were authored prose with tokens wedged in, not mad-libs, and needed surgical removal instead. 118 templates remain; the ticket stays open for them.
