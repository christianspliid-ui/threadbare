...
**Last updated:** 2026-08-25 18:54 local (16:54 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
Two of these have gone stale in the queue, so no lane has added a third even though the shelf is thin. Available whenever you want it: your own [one-button snapshot](https://linear.app/threadbare/issue/THR-1134).
...
Both design maps closed 2026-08-24: [the typed game-state map](https://linear.app/threadbare/issue/THR-1157) and [the vertical-slice map](https://linear.app/threadbare/issue/THR-902). Two new maps were chartered this morning — [powers](https://linear.app/threadbare/issue/THR-1226) and [items](https://linear.app/threadbare/issue/THR-1227) — and the hub is still unchartered. The slice map's charter names it as the successor: **the player reaching factions, war, economy and divine actions from inside the encounter interface.**
...
- 2026-08-25: **the two encounters sent for your verdict are withdrawn** — both lived in the file the corpus rewrite replaced wholesale. The ask returns once, at [the integrated checkpoint](https://linear.app/threadbare/issue/THR-1220), in the new voice.
- 2026-08-25: **the batch-1 sample verdict is retired** — [THR-1130](https://linear.app/threadbare/issue/THR-1130) led this page for three briefs. You answered it by playing one encounter, calling it borderline unreadable, and rewriting the prose rules.
- 2026-08-25: **you read the new encounters and ruled** — [THR-1221](https://linear.app/threadbare/issue/THR-1221) closed; your ruling became [Prose Doctrine v2](https://github.com/christianspliid-ui/threadbare/blob/main/.claude/skills/encounter-pipeline/reference/nudge-authoring-spec.md) ([PR #1606](https://github.com/christianspliid-ui/threadbare/pull/1606)) and two tickets.
