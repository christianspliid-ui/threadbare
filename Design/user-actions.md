...
**Last updated:** 2026-07-21 (item 2 added by the THR-653 Cowork cutover; light refresh at 00:54 local by the hourly `keep-work-flowing-cc` CC task; last full rebuild was the 2026-06-23 retro)
...
**Status:** Open, new 2026-07-20 · blocks the last step of the move off Cowork · **carried unanswered through the 2026-07-21 00:54 run**
...
**Status:** Open (cosmetic) · **the load-bearing doc landed.** `Docs/plans/2026-07-20-git-cicd-clean-delivery.md` merged to `origin/main` tonight via **PR #638** (verified `git cat-file -e origin/main:<path>`). THR-672, 673, 674, 675 and 676 — five Ready-for-Dev tickets, one High — all open with "**Plan doc:** … read first," and an executor claiming any of them can now read it from a fresh clone or an isolation worktree. **The starvation risk this item existed to name is closed.** (THR-671, the sixth, **shipped 2026-07-21 00:34 via PR #646**.)
...
**Status:** Cause found (2026-07-20 investigation) · last event 2026-07-20 ~11:00 (fourth in four days), **self-cleared by 11:54** with no human or agent repair · **no fifth event through the 2026-07-21 00:54 run** — the tree is on `main`, 20 behind, with three tracked files reading as changed that are **byte-identical to `origin/main`** (re-verified this run: `git diff origin/main -- <path>` empty for all three): phantom staleness, not authored work · **will keep recurring until THR-672 lands**, but the 07-20 event resolving itself is evidence the benign park is self-limiting and THR-672's auto-reattach is aimed correctly
