...
**Last updated:** 2026-09-02 10:55 local (08:55 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
**The shelf is down to one item, and the thing that was on it is nearly finished.** [The reactive loop](https://linear.app/threadbare/issue/THR-1298/the-reactive-loop-proactive-agent-actions-plan-doc-46) has [merged its first four slices](https://github.com/christianspliid-ui/threadbare/pull/1765) to the live site, with [the fifth and last](https://github.com/christianspliid-ui/threadbare/pull/1766) waiting on green. What is left unclaimed is [the calling & the surfaces](https://linear.app/threadbare/issue/THR-1299) — real product work, and the pipeline's whole remaining output. Once that is built, nothing refills behind it while the two tickets above hold the column.
...
- **Grudges and vendettas are live in the game** — [pull request #1765](https://github.com/christianspliid-ui/threadbare/pull/1765) merged 2026-09-02 and is serving. Harm an agent suffers now mints a drive that leans on who they are, not only what they can do; the last slice of that work is [in a pull request](https://github.com/christianspliid-ui/threadbare/pull/1766) waiting on green.
