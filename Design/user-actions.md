...
**Last updated:** 2026-08-29 18:58 local (16:58 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
- **Round 4 is four-fifths through in one afternoon** — [the engine-canon rewrite](https://linear.app/threadbare/issue/THR-1362) merged 16:12, [the AI-index refresh](https://linear.app/threadbare/issue/THR-1363) at 16:44, and [the skills pass](https://linear.app/threadbare/issue/THR-1364) at 18:27; [the wiring pass](https://linear.app/threadbare/issue/THR-1365) is in flight. Round 5 remains. Agent handbook only; nothing in the game changes.
