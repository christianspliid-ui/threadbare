...
**Last updated:** 2026-08-14 13:57 local (2026-08-14 11:57 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
*Nothing else is waiting on you. The two encounter verdict sessions ([THR-907](https://linear.app/threadbare/issue/THR-907), [THR-974](https://linear.app/threadbare/issue/THR-974)) are deliberately **not** being asked of you yet — under your own level-system rule the pieces are not all up, even though every ticket Linear names as a blocker is now Done. THR-907 is one ticket away ([THR-1107](https://linear.app/threadbare/issue/THR-1107), the ungrammatical prose lines); THR-974 waits on [THR-1097](https://linear.app/threadbare/issue/THR-1097), its content pass, now top of the queue. You will get one ask, once, when they are ready — or say the word and I will put them up half-built.*

## Resolved this period

- 2026-08-14: **the ally card you described on Tuesday is in the game.** [THR-1096](https://linear.app/threadbare/issue/THR-1096) ([PR #1448](https://github.com/christianspliid-ui/threadbare/pull/1448), merged 13:54, already deployed) — a named person with a portrait who rides along and grants a passive bonus, never simulated as an agent, arriving as an encounter consequence and rendering as a BOND chip. The eleventh thing to ship without you, and the first that is a feature rather than a fix. A pixel pass on the companions row is deferred to an attended session ([THR-1109](https://linear.app/threadbare/issue/THR-1109)).
