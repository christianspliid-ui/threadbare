...
**Last updated:** 2026-08-22 14:58 local (12:58 UTC). Standing asks only, per [THR-1077](https://linear.app/threadbare/issue/THR-1077). Run measurements, findings and narration live in the history: `git log -p origin/ops -- Design/user-actions.md`.
...
### 4. A design hour — two jobs waiting for it

The wave-1 sitting is **done** (see below) and its three follow-on sessions are agents' to prepare; they will arrive ready rather than needing this hour. Two design efforts still want an attended hour, in the order I would take them:
...
### 6. Image credits — who decides the spend?
