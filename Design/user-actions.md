...
**Last updated:** 2026-07-19, 13:29 local (light refresh by the hourly `keep-work-flowing-cc` CC task; last full rebuild was the 2026-06-23 retro)
...
**Status:** Open · **newly surfaced 2026-07-19 11:29** by the hourly `keep-work-flowing-cc` run; **re-verified still broken 2026-07-19 13:29** (`node_modules/.bin` still empty — zero shims — while `node_modules/vite` itself is present, confirming the packages are there but unlaunchable).
