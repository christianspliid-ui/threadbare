...
Two yes/no questions: **repair in place, or re-roll from fresh premises?** (repair is the plan; two lanes recommend it independently) and **the 2-of-6 sample** — `ward_the_camp` and `tend_to_wounds`.
...
What remains is genuinely just intent: **In Design, assigned to you, no plan doc.** The machine keeps it counted because an assigned item means a person may be about to start.
...
**Both reasons it went badly last time are fixed.** Three of the nine passes were impossible on 4 September because the game had no route to the surfaces; all three closed ([THR-1413](https://linear.app/threadbare/issue/THR-1413), [THR-1414](https://linear.app/threadbare/issue/THR-1414), [THR-1412](https://linear.app/threadbare/issue/THR-1412)). And the game **would not load** that day — the dev server was watching every lane worktree inside the repo folder. Fixed and shipped ([THR-1415](https://linear.app/threadbare/issue/THR-1415)).
...
The case in front of it is still the 4–6 September weekend: the machine was off for 45 hours and everything resumed on its own — nothing broke, nothing lost. The probe's own words, unchanged: *"If that was a deliberate pause, nothing recorded it; if it was not, this is the outage no lane reported at the time."*
