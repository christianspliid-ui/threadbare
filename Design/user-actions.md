...
### 3. What is a run *about*? — [THR-1198](https://linear.app/threadbare/issue/THR-1198/the-48-authored-mandate-strings-are-wired-but-unreachable-no-live-game)
...
### 8. Was the 20–22 August lane quiet deliberate?
...
- 2026-08-25: **the batch-1 sample verdict is retired** — [THR-1130](https://linear.app/threadbare/issue/THR-1130) led this page for three briefs asking whether two encounters were worth meeting twice. You answered it by playing one and calling it borderline unreadable, then rewriting the prose rules. The verdict now returns once, at [the integrated checkpoint](https://linear.app/threadbare/issue/THR-1220), on encounters in the new voice.
- 2026-08-25: **you read the new encounters and ruled** — [THR-1221](https://linear.app/threadbare/issue/THR-1221) closed; your ruling became [Prose Doctrine v2](https://github.com/christianspliid-ui/threadbare/blob/main/.claude/skills/encounter-pipeline/reference/nudge-authoring-spec.md) ([PR #1606](https://github.com/christianspliid-ui/threadbare/pull/1606)) and two tickets on the shelf, [THR-1223](https://linear.app/threadbare/issue/THR-1223) and [THR-1224](https://linear.app/threadbare/issue/THR-1224).
