# Briefing
**Generated:** 2026-09-24 22:58 local (20:58 UTC) · keep-work-flowing-cc
...
**Healthy: thirteen jobs ready, none in progress, no parked jobs.** One merge since the last brief:
- **Mortals now plan with the same odds the dice use** ([forecast window S2](https://linear.app/threadbare/issue/THR-1579/forecast-window-s2-the-forecast-is-the-roll-mortals-plan-with-the-odds)). It merged at 22:49 local via [#2022](https://github.com/christianspliid-ui/threadbare/pull/2022) and is live on the site. S3 is now at the top of the queue.
- High: [S3: re-fit the dice](https://linear.app/threadbare/issue/THR-1581/forecast-window-s3-re-fit-the-dice-skill-separates-an-even-match-is-a) — skill separates mortals, an even match becomes a gamble.
...
- Everything else is green. Tick cost is 60 ms per tick, 18% below the 7-day median of 72. The live site serves the #2022 merge, CI is healthy, no pull requests are waiting, all nine scheduled lanes are on time, and the home tree is current on `main`.
