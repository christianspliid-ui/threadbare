# Briefing
**Generated:** 2026-09-19 02:55 local (00:55 UTC) · keep-work-flowing-cc

## The one thing

**Say "design THR-1448" in a chat.** The board is still fully drained: nothing is ready to build and nothing is in progress. The plan you approved on 12 September is finished and there are no open bugs, so the machine has no game work it may start on its own. You already set the direction for both staged designs, so there's no decision to make. A design session just needs you to open it.
...
**Starved: 0 ready, 0 in progress.** No parked or stale items. [THR-1448](https://linear.app/threadbare/issue/THR-1448/a-held-town-is-a-faction-position-holding-opens-faction-encounters-and) and [THR-1479](https://linear.app/threadbare/issue/THR-1479/appointment-primitive-a-mortal-keeps-or-misses-a-meeting-at-a-place-by) are still in In Design, untouched since 12 September.

## Health

All green. The live site is on `3d39f728`, the latest main. There are no PRs waiting to merge. Scheduled workflows are healthy, and all 9 scheduled tasks are on time. Tick cost is 58 ms/tick, 12% below the 7-day median. The cleanup script ran at 02:40 and flagged 3 old worktrees for disposition.
