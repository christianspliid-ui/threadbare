# Briefing
**Generated:** 2026-09-23 11:58 local (09:58 UTC) · keep-work-flowing-cc
...
- **Were you away from the app on Monday 14 and Tuesday 15 September?** This is now a narrower question. The 17 and 18 September stops are explained: the computer was asleep. *— from [the workflow retro](https://github.com/christianspliid-ui/threadbare/blob/main/Design/retros/workflow-retro-2026-09-23.md)*
- **Fog or witness:** should a stranger's sheet show the wound you just watched them take? If you say nothing, it stays as it is.

## Queue

**Starved: one job ready, nothing in progress, no parked jobs.** The one ready job is [THR-1529](https://linear.app/threadbare/issue/THR-1529/a-pickup-run-killed-mid-slice-leaves-its-work-invisible-no-wip-push), a process fix of medium priority filed at 11:24 today. It clears the materiality bar: one builder run died 26 minutes into a job. The builder will take it next hour. After that the shelf is empty. The only live design item is [THR-1525](https://linear.app/threadbare/issue/THR-1525/signed-desire-score-vs-the-specs-step-6-a-fork-that-plants-on-its), about 29 hours on the desk; it is the ask above. Daily backlog grooming notes that [THR-1523](https://linear.app/threadbare/issue/THR-1523/spotlight-pull-the-swap-pool-is-the-handful-of-ambition-less-seeded) does not need you: a design session can pick an option and invite your veto.

## Health

- **Heavy simulation tests are green on today's commit.** The [08:34 UTC run](https://github.com/christianspliid-ui/threadbare/actions/runs/35837874948) passed on the same code that failed at 06:37, so the red was a slow runner, not broken code. The probe still reports "failing on main for 28 hours" because it counts the earlier red run. This is a technical call, not yours. The lasting fix, a longer time limit on those world-building tests, is a session's job.
...
- **Worktree reaper:** 5 worktrees await a decision on what to do with them (the 11:40 run). This is routine and is the reaper's call.
- Everything else is green. The live site is serving the latest game code (f50759a4); later commits touched only docs. CI is healthy, no pull requests are waiting, and all nine scheduled lanes are on time. Engine speed is 74 ms/tick, 6% above the 7-day median of 70, which is within normal range. The home tree is on `main` and current; only a local settings file is edited.
