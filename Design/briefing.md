# Briefing
**Generated:** 2026-09-25 04:55 local (02:55 UTC) · keep-work-flowing-cc
...
**Healthy: twelve jobs ready, none in progress, no parked jobs.** One merge since the last brief: **a lost fight now leaves its mark on the fighter** (defeat, scars, and a gate on when it can kill) ([THR-1548](https://linear.app/threadbare/issue/THR-1548/fight-endings-d1-endings-and-the-death-gate), fight endings D1, [#2027](https://github.com/christianspliid-ui/threadbare/pull/2027)), merged 04:44 local and live on the site. Not a review ask yet: [the opponent header](https://linear.app/threadbare/issue/THR-1551/fight-on-screen-f2-the-opponent-header) and [the lair card](https://linear.app/threadbare/issue/THR-1552/fight-on-screen-f4-the-lair-card) are still to come.
...
- **Heavy simulation tests: red again on the latest `main`** ([run](https://github.com/christianspliid-ui/threadbare/actions/runs/36087538087)). The same two world-simulation tests hit the 5-second timeout: the army-commander one and the harvest one. They failed at 02:36, passed at 03:36 and failed at 04:44, so this is a flaky time limit, not a broken game. The builder lane owns the fix. Nothing for you.
...
- Everything else is green. Tick cost is 62 ms per tick, 9% below the 7-day median of 68. The live site serves the latest `main` (c4e0d574), no pull requests are waiting, all nine scheduled lanes are on time, and the home tree is current on `main`.
