# Briefing
**Generated:** 2026-09-22 00:57 local (22:57 UTC) · keep-work-flowing-cc
...
Tonight the builder finished the appointment primitive — the piece that lets someone in the world promise to meet another person at a place, then keep or break that promise. It was designed as three parts. When part one closed at 22:12, **Linear closed parts two and three three tenths of a second later.** Nobody built them. Nobody started them. The board simply said they were done.
...
The orchestrator caught it twenty minutes later and put both back ([THR-1518](https://linear.app/threadbare/issue/THR-1518/appointment-primitive-slice-2-the-authoring-harness-guide-spec-die), [THR-1519](https://linear.app/threadbare/issue/THR-1519/appointment-primitive-slice-3-the-undertaking-grid-a-work-whose-payoff), both back in the queue). **Nothing was lost, and nobody made a mistake** — the builder did everything correctly; it is Linear closing unfinished children when their parent closes.
...
**Why now rather than later:** the same thing is loaded again. [THR-790](https://linear.app/threadbare/issue/THR-790/traits-wave-2-locations-artifacts-and-draw-by-trait-pools) (traits wave 2) sits in the queue with three unfinished parts under it — [THR-1520](https://linear.app/threadbare/issue/THR-1520/traits-wave-2-slice-2-draw-by-trait-completion-dedup-against-what-the), [THR-1521](https://linear.app/threadbare/issue/THR-1521/traits-wave-2-slice-3-artifact-traits-the-has-trait-schema-admits), [THR-1522](https://linear.app/threadbare/issue/THR-1522/traits-wave-2-slice-4-the-deferred-location-trait-consumers-merchant) — verified against the board this run. The moment the parent closes, all three are marked done the same way, including one a builder may be working on at that moment. A warning is left on the parent, but hand-checking every close is a guard that eventually gets forgotten.
...
- [THR-1518](https://linear.app/threadbare/issue/THR-1518/appointment-primitive-slice-2-the-authoring-harness-guide-spec-die) — appointment slice 2, the authoring harness · **High** · restored from the silent close
...
In Dev: [THR-1348](https://linear.app/threadbare/issue/THR-1348/ambitions-held-below-the-spotlight-tier-have-no-agency-path-10-of-the) (attention follows ambition). Yesterday's grooming report still opens with *"the delivery machine is idle"* — true when written at 17:41, overtaken hours later; no action follows from it.

## Health

**One amber, nothing for you.** The post-merge **Heavy simulation tests** job is red on the latest `main` (about an hour) — a follow-up fix owed by the next executor session, not a review call. It is deliberately not a required check, so it blocks no merge.

Everything else green: the live site is serving the newest commit (`7f4b8e98`); CI, the three scheduled jobs and the other post-merge workflows are passing; no PRs waiting to merge; all 9 scheduled tasks within schedule; the worktree reaper ran at 00:40.
