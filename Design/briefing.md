...
**Does siege go first? — [THR-1216](https://linear.app/threadbare/issue/THR-1216/director-ruling-the-encounter-target-mix-does-siege-go-first)**

You said the encounters converge on travel-and-meet-people. [The assessment you asked for](https://github.com/christianspliid-ui/threadbare/blob/main/Docs/audits/2026-08-24-encounter-portfolio-assessment.md) came back with the number: **six of the eight slice encounters open on a roadside**, and nothing in the game fights on a battlefield. The epic material is not missing — it is *old*. Twenty-three ruin-and-delve premises, twenty war-and-siege, thirteen deep-magic, every one of them legacy content. **The game's new voice has only ever spoken slice-of-life.**
...
- **[THR-1130](https://linear.app/threadbare/issue/THR-1130/encounter-factory-pilot-volume-retrofit-the-15-nudge-era-encounters-to) — are these two worth meeting twice?** [The Grateful Kin](https://threadbare.vercel.app/?view=game&seeded&size=medium&spawn=encounter.slice.grateful_kin) · [The Unsafe Bridge](https://threadbare.vercel.app/?view=game&seeded&size=medium&spawn=encounter.slice.unsafe_bridge). Nine days open — the oldest ask on the board.
- **Design hours — only a sitting with you adds new ground.** Four stacked: [card grammar](https://linear.app/threadbare/issue/THR-1002/unify-the-card-grammar-action-cards-adopt-the-encounter-card) (5 days), [traits wave 2](https://linear.app/threadbare/issue/THR-790/traits-wave-2-locations-artifacts-and-draw-by-trait-pools) (9 days), [shared anchor machinery](https://linear.app/threadbare/issue/THR-1212/wave-1-design-a-shared-anchor-machinery-the-typed-anchor-the-generated), [hunger vocabulary](https://linear.app/threadbare/issue/THR-1213/wave-1-design-b-hunger-vocabulary-unification-one-catalog-one-key).
