# Briefing
**Generated:** 2026-09-25 05:58 local (03:58 UTC) · keep-work-flowing-cc
...
**Healthy: twelve jobs ready, none in progress, no parked jobs.** One merge since the last brief: **the fight screen now shows who the mortal faces and how close it is to falling** ([THR-1551](https://linear.app/threadbare/issue/THR-1551/fight-on-screen-f2-the-opponent-header), fight on screen F2, [#2028](https://github.com/christianspliid-ui/threadbare/pull/2028)). It merged at 05:43 local and is live on the site. This is not a review ask yet, because [the lair card](https://linear.app/threadbare/issue/THR-1552/fight-on-screen-f4-the-lair-card) and [what the winner takes home](https://linear.app/threadbare/issue/THR-1549/fight-endings-d2-victory-yields-and-the-chronicle) are still to come.
...
- **Everything else is green.** The heavy simulation tests pass again on the latest `main` ([run](https://github.com/christianspliid-ui/threadbare/actions/runs/36091532575)), so last hour's red was the flaky time limit. Tick cost is 61 ms per tick, 11% below the 7-day median of 68. The live site serves the latest `main` (d33665c3). No pull requests are waiting, all nine scheduled lanes are on time, and the home tree is current on `main`.
