# Briefing
**Generated:** 2026-09-10 01:58 local (2026-09-09 23:58 UTC) · keep-work-flowing-cc

## The one thing

**Open two encounters and say whether they are worth meeting twice** — [THR-1130](https://linear.app/threadbare/issue/THR-1130/encounter-factory-pilot-volume-retrofit-the-15-nudge-era-encounters-to). The camp six shipped four hours ago and are live. Your own rule samples two of every six; these are the widest tonal gap in the batch:
...
- [**Rule on the backlog**](https://linear.app/threadbare/issue/THR-1195) — ~14 tickets waiting on a sentence from you, not on effort. One more joined tonight. Say *"rule on the backlog"* and they arrive smallest first. **This is why the shelf keeps emptying.**
...
- **Was the quiet deliberate?** — you ruled overnight quiet normal; **weekends are still unruled**, and last weekend held a 45-hour gap, so the probe keeps raising them. One word sets the marker.
...
- **Parked, waiting on you:** [THR-1130](https://linear.app/threadbare/issue/THR-1130) — the batch-2 sample verdict above. This is the only park on the board.
- **In flight:** [THR-1002](https://linear.app/threadbare/issue/THR-1002) (card grammar) committing as of 23:10 UTC.

## Health

**All green.** Site serving `5fd85f0e`, CI green on main, no PRs waiting, all 9 scheduled lanes on schedule, tick cost 64 ms/tick (24% *under* the 7-day median). Reaper ran 15 minutes ago.
