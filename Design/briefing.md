...
- **[Design hours — the shelf is dry](https://linear.app/threadbare/issue/THR-1002/unify-the-card-grammar-action-cards-adopt-the-encounter-card)** · zero tickets on the board, nothing in build. Sit [the card grammar](https://linear.app/threadbare/issue/THR-1002) or [traits wave 2](https://linear.app/threadbare/issue/THR-790), or say *"park it"* — four plan-doc sessions are behind them. Detail: [user-actions §2](https://github.com/christianspliid-ui/threadbare/blob/ops/Design/user-actions.md).
