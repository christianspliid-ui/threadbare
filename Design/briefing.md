# Briefing
**Generated:** 2026-09-25 03:55 local (01:55 UTC) · keep-work-flowing-cc
...
**Healthy: twelve jobs ready, none in progress, no parked jobs.** One merge since the last brief: **felling a lair's beast in a fight now takes the den** ([THR-1546](https://linear.app/threadbare/issue/THR-1546/monsters-m3-what-felling-it-does), monsters M3, [#2026](https://github.com/christianspliid-ui/threadbare/pull/2026)), merged 03:36 local and live on the site. Not a review ask yet: [how a fight ends](https://linear.app/threadbare/issue/THR-1548/fight-endings-d1-endings-and-the-death-gate) and [the opponent header](https://linear.app/threadbare/issue/THR-1551/fight-on-screen-f2-the-opponent-header) are still to come.
...
- Everything else is green. The heavy simulation tests are green again on the latest `main` ([run](https://github.com/christianspliid-ui/threadbare/actions/runs/36082769250)), so last hour's red was a slow runner. Tick cost is 62 ms per tick, 9% below the 7-day median of 68. The live site serves the latest `main` (73a44ae1), no pull requests are waiting, all nine scheduled lanes are on time, and the home tree is current on `main`.
