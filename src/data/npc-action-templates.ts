...
export const NPC_ACTION_TEMPLATES: readonly UnifiedActionTemplate[] = [
...

  {
    ...
    description: 'Turn the ambient noise of their life into signal. Every muttered worry and half-spoken name rises to a patient ear.',
    reach: 'eye',
    crudType: 'read',
    scale: 'personal',
    steps: [{
    ...
    motivations: [],
    narrativeTemplates: {
      initiation: 'Awareness spreads like smoke through the cracks of their daily life.',
      success: 'A fragment of truth surfaces — overheard, stolen, carried away.',
