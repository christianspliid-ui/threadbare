          ...
          changes: [
            {
              ...
              kind: 'trait',
              title: 'Steady Hands',
              causeClause: 'Crossed a failing span without touching the rail',
              detail: 'The certainty holds for a while.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
          ...
          changes: [
            {
              ...
              kind: 'trait',
              title: 'Ford-Worn',
              causeClause: 'The ford took the rest of the daylight',
              detail: 'They start tomorrow’s road already spent.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
          ...
          changes: [
            {
              ...
              kind: 'trait',
              title: 'The Fall',
              causeClause: 'The crossing ended in the water',
              detail: 'The leg will have opinions about stairs.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
            ...
            },
            {
              ...
              causeClause: 'The river decided when they came up',
              detail: 'Crossings get a wide berth now.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
      ...
      changes: [
        {
          ...
          kind: 'shell_state',
          title: 'The Season',
          causeClause: 'They came off the high ground',
          detail: 'The far side is theirs until spring.',
          polarity: 'info',
          category: 'path',
          direction: 'opens',
          ...
          changes: [
            {
              ...
              causeClause: 'A roof and a fire, reached in time',
              detail: 'They start the descent rested.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
              ...
              stateNoun: { text: 'rested', tooltipId: 'ui.consequence.boon' },
            },
          ],
          reactions: [
            {
          ...
          changes: [
            {
              ...
              kind: 'trait',
              title: 'Spent',
              causeClause: 'The climb took what the descent needs',
              detail: 'They start down already owing.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
              stateNoun: { text: 'exhausted', entityId: 'trait.condition.exhausted', visualKind: 'attachment' },
        ...
        failure: {
          ...
          changes: [
            ...
            },
            {
              ...
              causeClause: 'A night spent arguing themselves out of fear',
              detail: 'Their own judgement reads thinner now.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
              // THR-1472 — was 'the nerve they came down with' anchored to `$actor`:
              // a scene phrase for a state the engine had no word for (the
              // `quintessence_shift` below wrote a number and named nothing). The
              // condition now exists, the reaction grants it, and the chip names it.
              stateNoun: { text: 'shaken', entityId: 'trait.condition.shaken', visualKind: 'attachment' },
            },
          ],
          reactions: [
            {
          ...
          changes: [
            {
              ...
              causeClause: 'Two days of frost, badly fed',
              detail: 'Hands and feet will be weeks forgiving them.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
              stateNoun: { text: 'wounded', entityId: 'trait.condition.wounded', visualKind: 'attachment' },
      ...
      changes: [
        {
          ...
          kind: 'shell_state',
          title: 'The Column',
          causeClause: 'Four days walked inside a hunted column',
          detail: 'The caravan roads are open to them.',
          polarity: 'info',
          category: 'path',
          direction: 'opens',
          stateNoun: { text: 'knowledge', tooltipId: 'ui.knowledge' },
          ...
          changes: [
            {
              ...
              causeClause: 'Someone watched them ask the questions',
              detail: 'A walker can point them out later.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
          ...
          changes: [
            {
              ...
              causeClause: 'Four days spent on the wrong questions',
              detail: 'They reach the gate knowing how it ends.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
              // THR-1472 — the slice's second nerve scar, same fix as
              // `slice.pass.what_the_dark_took`: the state now has a word, the
              // reaction grants it, and the tag reads on a sheet without this
              // encounter in memory.
              stateNoun: { text: 'shaken', entityId: 'trait.condition.shaken', visualKind: 'attachment' },
            },
          ],
          ...
          changes: [
            {
              ...
              causeClause: 'They took the blow meant for another',
              detail: 'It travels into the town with them.',
              polarity: 'loss',
              category: 'scar',
              direction: 'loss',
              stateNoun: { text: 'wounded', entityId: 'trait.condition.wounded', visualKind: 'attachment' },
        ...
        changes: [
          {
            ...
            causeClause: 'They said yes, out loud',
            detail: 'The claim falls due at full moon.',
            ...
            changes: [
              {
                ...
                kind: 'trait',
                title: 'Given Clean',
                causeClause: 'They answered plainly and hedged nothing',
                detail: 'The claim is exactly the size they spoke.',
                polarity: 'info',
                category: 'bond',
                direction: 'loss',
                stateNoun: { text: 'agreement', tooltipId: 'ui.agreement' },
            ...
            changes: [
              {
                ...
                causeClause: 'The word left them on an ordinary road',
                detail: 'The first night’s sleep goes with it.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'agreement', tooltipId: 'ui.agreement' },
            ...
            changes: [
              {
                ...
                kind: 'trait',
                title: 'Spoken Away',
                causeClause: 'The promise did not feel like theirs',
                detail: 'It is out of their keeping now.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'agreement', tooltipId: 'ui.agreement' },
            ...
            changes: [
              {
                ...
                causeClause: 'They refused an offer shaped to fit',
                detail: 'He knows what they want most now.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'hidden mark', tooltipId: 'ui.hidden_mark' },
      ...
      changes: [
        {
          ...
          causeClause: 'They took a road and left the stone',
          detail: 'They know the road back to it.',
          polarity: 'info',
          category: 'path',
          direction: 'opens',
          ...
          effects: [
            {
              ...
              category: 'talisman',
              targetAgentId: '$actor',
              nameOverride: 'The Crossroads Gift',
          ...
          changes: [
            {
              ...
              kind: 'item',
              title: 'The Crossroads Gift',
              causeClause: 'He let go without a second clause',
              detail: 'The gift is theirs outright.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
            ...
            },
            {
              ...
              kind: 'shell_state',
              title: 'He Left First',
              causeClause: 'He walked out of the moonlight first',
              detail: 'No claim at the crossroads holds them.',
              polarity: 'gain',
              category: 'bond',
              direction: 'gain',
              stateNoun: { text: 'agreement', tooltipId: 'ui.agreement' },
          ...
          changes: [
            {
              ...
              kind: 'item',
              title: 'The Crossroads Gift',
              causeClause: 'The promise was kept in full',
              detail: 'The parcel came across as agreed.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
              // G1: carrier-anchored — see the note on 'slice.fullmoon.the_gift'.
            ...
            },
            {
              ...
              causeClause: 'He added a sentence and did not wait',
              detail: 'They owe a meeting nobody agreed to.',
              polarity: 'loss',
              category: 'bond',
              direction: 'loss',
              stateNoun: { text: 'seed', tooltipId: 'ui.aftermath_seed' },
          ...
          changes: [
            {
              ...
              kind: 'item',
              title: 'The Crossroads Gift',
              causeClause: 'He gave the parcel whole',
              detail: 'The gift is real and entire.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
              // G1: carrier-anchored — see the note on 'slice.fullmoon.the_gift'.
            ...
            },
            {
              ...
              causeClause: 'He took the kept promise and bowed',
              detail: 'Their name stays on his list.',
              polarity: 'loss',
              category: 'bond',
              direction: 'loss',
              stateNoun: { text: 'agreement', tooltipId: 'ui.agreement' },
            ...
            changes: [
              {
                ...
                causeClause: 'The turn took until dusk to find',
                detail: 'They are a day behind, and it mattered.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'delay', tooltipId: 'ui.consequence.scar' },
        ...
        changes: [
          {
            ...
            causeClause: 'They let the handcart go east alone',
            detail: 'Their day and the town both hold.',
            polarity: 'info',
            category: 'path',
            direction: 'opens',
            stateNoun: { text: 'seed', tooltipId: 'ui.aftermath_seed' },
            ...
            changes: [
              {
                ...
                causeClause: 'A quiet evening, spent on the fen',
                detail: 'They make the town, and lie awake counting.',
            ...
            reactions: [
              {
                ...
                effects: [
                  // THR-1472 — the chip names `shaken`, so the band grants it.
                  // The shift alone wrote a number and no word, which is why the
                  // noun used to read 'their own certainty'.
                  { kind: 'condition_attachment', templateId: 'trait.condition.shaken' },
                  {
                    kind: 'quintessence_shift',
                    delta: SLICE_NERVE_EROSION,
      ...
      changes: [
        {
          ...
          kind: 'shell_state',
          title: 'Two Roads',
          causeClause: 'A cart came the wrong way past them',
          detail: 'They know what lies east of here.',
          polarity: 'info',
          category: 'path',
          direction: 'opens',
          stateNoun: { text: 'knowledge', tooltipId: 'ui.knowledge' },
            ...
            changes: [
              {
                ...
                causeClause: 'He packed up before any warden moved',
            ...
            changes: [
              {
                ...
                kind: 'trait',
                title: 'The Argument',
                causeClause: 'He paid, and not quietly',
                detail: 'The bruises outlast the money.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'wounded', entityId: 'trait.condition.wounded', visualKind: 'attachment' },
            ...
            changes: [
              {
                ...
                kind: 'trait',
                title: 'The Knife',
                causeClause: 'He was readier for the alley, and not alone',
                detail: 'They were cut behind the scales.',
                polarity: 'loss',
                category: 'scar',
                direction: 'loss',
                stateNoun: { text: 'wounded', entityId: 'trait.condition.wounded', visualKind: 'attachment' },
      ...
      changes: [
        {
          ...
          causeClause: 'They stood until the stalls folded',
          detail: 'His pitch, patter and hours are known now.',
          polarity: 'info',
          category: 'path',
          direction: 'opens',
          stateNoun: { text: 'knowledge', tooltipId: 'ui.knowledge' },
    ...
    fallback: {
      ...
      changes: [
        ...
        // the name.
        {
          ...
          causeClause: 'The coin went back twice, publicly',
          detail: '{target} keeps a door open for them.',
          polarity: 'gain',
          category: 'bond',
          direction: 'gain',
          ...
          changes: [
            {
              ...
              kind: 'reputation',
              title: 'A Standing Welcome',
              causeClause: 'They let her say it to the room',
              detail: '{target} says the door is open.',
              polarity: 'gain',
              category: 'bond',
              direction: 'gain',
            ...
            },
            {
              ...
              causeClause: 'She pressed it on them, no discussion',
              detail: 'Her people will know it on sight.',
              polarity: 'gain',
              category: 'boon',
              direction: 'gain',
              // G1: carrier-anchored — see the note on 'slice.fullmoon.the_gift'.
              stateNoun: { text: 'The Pressed Keepsake', entityId: '$artifact', visualKind: 'artifact' },
          ...
          changes: [
            {
              ...
              causeClause: 'A long public thanks, three times over',
              detail: 'The open door cost them the evening.',
          ...
          changes: [
            {
              ...
              causeClause: 'They stood the public thanks badly',
              detail: 'The door stays open, narrower than intended.',
      ...
      positive: {
        ...
        changes: [
          tableStandingChip(
            ...
            'A Welcome Renewed',
            'Two camps held one causeway',
            '{target} keeps the door open, and both ends know why.',
            'gain',
          ...
          critical_success: {
            ...
            changes: [
              tableStandingChip(
                ...
                'A Welcome Deepened',
                'The riders turned without testing the line',
                '{target} opens the door wider.',
                'gain',
              ...
              ),
              {
                ...
                causeClause: 'The keeper put it in their hand',
                detail: 'It stood at the near end that night.',
                polarity: 'gain' as const,
                category: 'boon' as const,
                direction: 'gain' as const,
                stateNoun: { text: 'The Causeway Lamp', entityId: '$artifact', visualKind: 'artifact' as const },
          ...
          success_at_cost: {
            ...
            changes: [
              tableStandingChip(
                ...
                'Holding it put people in the fen',
                '{target} keeps the door open, counting.',
                'gain',
          ...
          failure: {
            ...
            changes: [
              tableStandingChip(
                'slice.table.the_gap',
                'A Welcome Spent',
                'The plan was theirs, and it had a gap',
                '{target} keeps a cooler door now.',
                'loss',
          ...
          critical_failure: {
            ...
            changes: [
              tableStandingChip(
                ...
                'People were carried off the causeway',
                '{target} keeps the door open out of habit.',
                'loss',
      ...
      negative: {
        ...
        changes: [
          tableStandingChip(
            ...
            'A Welcome Renewed',
            'Both camps loaded the same carts overnight',
            '{target} keeps the door open on their count.',
            'gain',
            SLICE_TABLE_BAND_RENEWED,
          ),
        ],
          ...
          critical_success: {
            ...
            changes: [
              tableStandingChip(
                ...
                'A Welcome Deepened',
                'Nothing was left for the riders',
                '{target} opens the door wider, barns still full.',
                'gain',
                SLICE_TABLE_BAND_DEEPENED,
              ),
              {
                ...
                causeClause: 'The keeper copied it out fair',
                detail: 'They carry the order the fen side emptied by.',
                polarity: 'gain' as const,
                category: 'boon' as const,
                direction: 'gain' as const,
                stateNoun: { text: 'The Loading Order', entityId: '$artifact', visualKind: 'artifact' as const },
          ...
          success_at_cost: {
            ...
            changes: [
              tableStandingChip(
                ...
                'Half the winter’s grain stayed behind',
                '{target} keeps the door open; two households go short.',
                'gain',
                SLICE_TABLE_BAND_TOLL,
              ),
            ],
          ...
          failure: {
            ...
            changes: [
              tableStandingChip(
                ...
                'A Welcome Spent',
                'Their order ran long into first light',
                '{target} keeps a cooler door now.',
                'loss',
                SLICE_TABLE_BAND_SPENT,
              ),
          ...
          critical_failure: {
            ...
            changes: [
              tableStandingChip(
                ...
                'A Welcome Spent Badly',
                'Their order emptied the wrong barn first',
                '{target} keeps the door open from habit.',
                'loss',
                SLICE_TABLE_BAND_SPENT_HARD,
              ),
            ],
    ...
    fallback: {
      ...
      changes: [
        tableStandingChip(
          ...
          'A Welcome Renewed',
          'They sat until the table settled',
          '{target} keeps the door open, and the town watched.',
          'gain',
          SLICE_TABLE_BAND_RENEWED,
        ),
      ],
