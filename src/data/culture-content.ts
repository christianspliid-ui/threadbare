...
export const FOUNDATION_MODIFIERS: FoundationModifier[] = [
  ...
  },
  {
    ...
    reachWeights: { iron: 0.2, gold: 0.3, shadow: 0.4, veil: 0.2, heart: -0.3, eye: -0.1, star: -0.1 },
  },
];
...
export const CREATION_SPHERE_MODIFIERS: CreationSphereModifier[] = [
  {
    ...
    reachWeights: { iron: 0.6, gold: 0.3, shadow: 0.2 },
  },
  {
    sphere: 'matter',
  ...
  },
  {
    ...
    reachWeights: { iron: 0.3, gold: 0.4, star: 0.2 },
  },
  {
    sphere: 'life',
    ...
    reachWeights: { gold: 0.5, heart: 0.3, eye: 0.2 },
  },
  {
    sphere: 'mind',
...
export const BIOME_MODIFIERS: BiomeModifier[] = [
  // Water group (4)
  {
    ...
    reachWeights: { eye: 0.3, gold: 0.3, heart: 0.2, star: 0.2 },
  ...
  // Lowlands (4)
  {
    ...
    reachWeights: { heart: 0.2, gold: 0.2, eye: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.3, eye: 0.3, iron: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { iron: 0.3, gold: 0.3, eye: 0.2 },
  ...
  // Forest (4)
  {
    ...
    reachWeights: { gold: 0.3, eye: 0.2, veil: 0.2, heart: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { veil: 0.3, gold: 0.3, eye: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.4, stone: 0.2, veil: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.4, shadow: 0.3, veil: 0.2 },
  ...
  // Wet (2)
  {
    ...
    reachWeights: { veil: 0.3, gold: 0.3, shadow: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { stone: 0.5, iron: 0.3, gold: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { stone: 0.4, eye: 0.3, gold: 0.2 },
  ...
  // Extreme (4)
  {
    ...
    reachWeights: { gold: 0.4, eye: 0.3, star: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.5, heart: 0.2, star: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { stone: 0.4, gold: 0.3, eye: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { iron: 0.4, stone: 0.3, gold: 0.3 },
  ...
  // New terrain types
  {
    ...
    reachWeights: { shadow: 0.4, gold: 0.3, veil: 0.3 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.4, veil: 0.3, shadow: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.3, stone: 0.2, veil: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { heart: 0.3, eye: 0.2, gold: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.4, star: 0.3, eye: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.5, heart: 0.3, iron: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { gold: 0.4, eye: 0.3, veil: 0.2 },
  ...
  // Gap terrains (referenced elsewhere but previously missing from BIOME_MODIFIERS)
  {
    ...
    reachWeights: { stone: 0.3, gold: 0.2, veil: 0.2, eye: 0.2 },
  ...
  },
  {
    ...
    reachWeights: { heart: 0.4, gold: 0.3, star: 0.2 },
...
export const FORMATIVE_TRAIT_SEEDS: FormativeTraitSeed[] = [
  ...
  },
  {
    ...
    sourceTags: ['energy'],
    domainContributions: { gold: 2, iron: 1 },
  ...
  },
  {
    ...
    sourceTags: ['energy'],
    domainContributions: { veil: 2, gold: 1 },
  ...
  },
  {
    ...
    sourceTags: ['life'],
    domainContributions: { gold: 2, eye: 1 },
    tags: ['healing', 'nature'],
  },
  {
    id: 'midwifery',
    ...
    sourceTags: ['life'],
    domainContributions: { heart: 2, gold: 1 },
    tags: ['healing', 'social'],
  },
  {
    id: 'literacy',
  ...
  },
  {
    ...
    domainContributions: { eye: 1, gold: 1 },
  ...
  },
  {
    ...
    domainContributions: { star: 1, gold: 1 },
...
export const BEHAVIORAL_TRAIT_SEEDS: BehavioralTraitSeed[] = [
  ...
  },
  {
    ...
    domainContributions: { gold: 1, iron: 1 },
  ...
  },
  {
    ...
    domainContributions: { iron: 1, gold: 1 },
    tags: ['risk', 'survival'],
  },
  {
  ...
  },
  {
    ...
    domainContributions: { heart: 1, gold: 1 },
