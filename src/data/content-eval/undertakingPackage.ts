...
export function undertakingPackageViolations(pkg: UndertakingContentPackage): readonly string[] {
  if (pkg.cell) {
    ...
    const legalOverride = ['displayName', 'activityProse', 'completionProse', 'cast', 'creationEffects', 'executionMode', 'projectDuration', 'catalystEncounterIds', 'catalystQuery', 'appointmentPayoff', 'reachProfile'];
