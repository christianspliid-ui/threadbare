...
export const SURFACE_ORIGIN_PROSE: Record<string, string[]> = {
  tragic_hero: [
    ...
    'A scribe in {culture} kept a record of {name}\'s decisions for a while. They stopped when the pattern got obvious.',
    '{name} is the kind of {archetype} that people describe in the past tense by accident.',
  ],
  trickster: [
    ...
    'Two households in {culture} both claim {name} as a guest that season. The dates overlap.',
    'Everyone agrees {name} is a {archetype}. They disagree about whether that is a warning.',
  ],
  coming_of_age: [
    ...
    'The smith in {culture} gave {name} a harder task than the work required. Everyone understood why except {name}.',
    '{name} is a {archetype} still finding out which of their habits are permanent.',
  ],
  brooding_warrior: [
    ...
    '{name} eats alone in {culture} and nobody has ever taken it personally.',
    '{name} is the kind of {archetype} who sits facing the door. No one in the room has asked why.',
  ],
  fallen_noble: [
    ...
    'The tailor in {culture} recognized the stitching on {name}\'s old coat and said nothing about it.',
    '{name} still corrects the grammar of people who now outrank them. A {archetype} habit that has cost them work.',
  ],
  true_believer: [
    ...
    'Merchants in {culture} do not try to haggle with {name} twice.',
    'Nobody has ever asked {name} what they think and received a short answer. The {archetype} is thorough.',
  ],
  schemer: [
    ...
    'A clerk in {culture} noticed {name} asking after grain prices in a year {name} bought no grain.',
    '{name} is the {archetype} who arrives at a meeting having already spoken to everyone in it.',
  ],
  wanderer: [
    ...
    'The innkeepers of {culture} keep no record of {name}. {name} never stayed long enough to need one.',
    '{name} is a {archetype} who packs like someone expecting to leave before dawn. They usually do.',
  ],
  monster: [
    ...
    'Something in {culture} stopped using the north road after {name} did. Nobody has connected the two out loud.',
    '{name} is called a {archetype} by people who mean it as a description and not an insult.',
  ],
  folk_hero: [
    ...
    'There are four songs about {name} in {culture}. {name} has heard none of them all the way through.',
    '{name} is a {archetype} whose legend has outgrown the person carrying it around.',
  ],
  reluctant_king: [
    ...
    'The council of {culture} sends for {name} and then waits. {name} always comes late and always comes.',
    '{name} is a {archetype} with a bag packed. It has been packed for years.',
  ],
  oathkeeper: [
    ...
    'Contracts in {culture} sometimes name {name} as witness. The parties treat that as sufficient.',
    '{name} is a {archetype} who says less than most people, because everything they say has to be kept.',
  ],
  poisoned_court: [
    ...
    'At table in {culture}, {name} waits to see who drinks first. It is not fear. It is habit.',
    '{name} is a {archetype} who remembers what you said last time, and the time before that.',
  ],
  doomed_innocent: [
    ...
    'Thieves in {culture} have twice returned things to {name} without being asked.',
    'People shield {name} from things a {archetype} should have learned years ago. They keep choosing not to teach them.',
  ],
  old_power: [
    ...
    'The oldest maps in {culture} carry {name}\'s name in a hand nobody writes in anymore.',
    '{name} is a {archetype} who has watched this exact argument three times before.',
  ],
  kingmaker: [
    ...
    'Nobody in {culture} can name a decision {name} made. Several can name decisions {name} was in the room for.',
    '{name} is a {archetype} who has never held a title and has never needed one.',
  ],
  seeker: [
    ...
    'The archivists of {culture} know {name} by which shelves come back empty.',
    '{name} is a {archetype} who answers a question with a better question and considers that helpful.',
  ],
  maker: [
    ...
    'Half the door hinges in {culture} are {name}\'s work. None of them are signed.',
    '{name} is a {archetype} who cannot sit in a badly built chair without diagnosing it.',
  ],
  noble_savage: [
    ...
    'When {name} speaks the language of {culture}, the accent is perfect and slightly too careful.',
    '{name} is a {archetype} with two sets of manners, using whichever one is not expected.',
  ],
};
...
export const SURFACE_SPHERE_PROSE: Record<string, string[]> = {
  force: [
    ...
    'Nothing changes when {name} enters a room, but the {sphere} makes people aware of where the exits are.',
    'The {sphere} in {name} is not aggression. It is settled knowledge of what their body can do, carried without needing to demonstrate it, which is why arguments near {name} tend to resolve before they escalate.',
  ],
  matter: [
    ...
    'The {sphere} shows in what {name} reaches for first: the joint, the seam, the place where two things were made to meet.',
    '{name} knows the weight of a thing by looking at it. The {sphere} has turned estimation into a sense rather than a calculation, and they are rarely more than a little wrong.',
  ],
  energy: [
    ...
    'The {sphere} in {name} is why they are already standing when everyone else decides to stand.',
    'Fires burn a little hotter where {name} tends them, and nobody has proven this. The {sphere} works at the edge of what can be measured, which is where most people stop looking.',
  ],
  life: [
    ...
    'The {sphere} is visible in {name} in their attention toward things that grow: plants left to wilt in others\' care that find their way toward health in {name}\'s. The {sphere} chooses its agents partly through tendency.',
    ...
    'The {sphere} in {name} shows in what follows them: dogs, children, and the sick, none of whom were invited.',
    '{name} notices the failing thing in a room before the thriving ones. The {sphere} tunes attention toward what is losing, which is useful in a healer and exhausting in a person.',
  ],
  mind: [
    ...
    'The {sphere} in {name} is visible in the pause. They answer a beat late, and the answer is better for it.',
    '{name} remembers the shape of an argument long after forgetting who made it. The {sphere} keeps the structure and discards the personalities, which makes them hard to flatter and harder to insult.',
  ],
  spirit: [
    ...
    'The {sphere} in {name} shows at thresholds. Doorways, graves, the start of things. They pause where others walk through.',
    '{name} keeps promises made to people who are dead. The {sphere} does not treat that as a technicality, and {name} has stopped explaining it to anyone who does.',
  ],
  time: [
    ...
    'The {sphere} in {name} shows in how they date things. Not by the year, but by what had not happened yet.',
    '{name} is unhurried in a way that unsettles hurried people. The {sphere} has given them the long view, and from there most emergencies look like weather.',
  ],
  entropy: [
    ...
    'The {sphere} in {name} shows in what they check first: the rust, the crack, the joint that has started to give.',
    '{name} is who people fetch once a thing has already broken. The {sphere} makes them steady in the aftermath, because to them the aftermath is only the next legible state of the thing.',
  ],
};
...
export const BOND_HISTORY_PROSE: Record<string, string[]> = {
  friendship: [
    ...
    'The {basis} between {name} and {bond} is mostly silence and shared work. Neither has described it out loud.',
    '{name} and {bond} argue the way people do when the {basis} underneath is not in question. Onlookers mistake it for a falling-out about once a year.',
  ],
  rivalry: [
    ...
    'The {basis} between {name} and {bond} has rules neither wrote down and neither has broken.',
    '{name} tracks {bond}\'s successes more carefully than their own. That is what the {basis} has made of them, and both would call it a fair trade.',
  ],
  loyalty: [
    ...
    'The {basis} {name} holds toward {bond} does not require {bond} to be right. It has been tested on exactly that point.',
    '{name} has been asked to justify their {basis} to {bond} several times. The justifications get shorter each year and convince fewer people.',
  ],
  alliance: [
    ...
    'The {basis} between {name} and {bond} began as an arrangement with an end date. Nobody has mentioned the date in some time.',
    '{name} and {bond} still keep the {basis} in writing. Neither has read the document since the first year.',
  ],
  trade: [
    ...
    'The {basis} between {name} and {bond} has never needed a witness. Both know what that is worth.',
    '{name} once quoted {bond} a price below cost and said nothing about it. The {basis} has run on that kind of accounting since.',
  ],
  faith: [
    ...
    'The {basis} {name} shares with {bond} is practiced more than discussed. Both prefer it that way.',
    '{name} and {bond} keep the same observances at the same hours in different rooms. The {basis} does not require them to be together, only to be consistent.',
  ],
  lineage: [
  ...
  gratitude: [
    ...
    'What {name} owes {bond} does not come up. The {basis} is understood by both and mentioned by neither.',
    '{name} has tried three times to settle the {basis} with {bond} and been refused each time. The refusals have become their own kind of bond.',
  ],
};
...
export const BOND_HISTORY_NEGATIVE_PROSE: Record<string, string[]> = {
  friendship: [
    ...
    'The {basis} between {name} and {bond} ended without a conversation. Each would say the other stopped first.',
    '{name} still knows how {bond} takes their drink. The {basis} left that behind along with everything less useful.',
  ],
  rivalry: [
    ...
    'The {basis} between {name} and {bond} stopped being about the contest some years ago. Neither has found a way to say so.',
    '{name} would not call {bond} an enemy. {name} would also not be in a room with them, and the {basis} is why.',
  ],
  loyalty: [
    ...
    'The {basis} {name} gave {bond} was spent and not returned. {name} keeps a shorter list now.',
    '{name} defended {bond} in public and learned afterward what the defence had covered. The {basis} did not survive the order of those two events.',
  ],
  alliance: [
    ...
    'The {basis} between {name} and {bond} held right up until the terms cost {bond} something.',
    '{name} and {bond} still greet each other correctly in public. The {basis} is dead and the manners have outlived it.',
  ],
  trade: [
    ...
    'The {basis} between {name} and {bond} ended over a sum neither will name, which suggests it was small.',
    '{name} deals with {bond}\'s people now, and not with {bond}. The {basis} continues. The trust does not.',
  ],
  faith: [
    ...
    'The {basis} {name} shared with {bond} did not break. It thinned over years until there was nothing left to break.',
    '{name} watched {bond} adjust the {basis} to fit a convenient outcome. It was a small adjustment. {name} has not managed to stop seeing it.',
  ],
  lineage: [
  ...
  gratitude: [
    ...
    'The {basis} {name} owes {bond} has been mentioned once too often to still be a gift.',
    '{bond} has taken to introducing {name} with the story of what {bond} did for them. The {basis} does not survive being told that way.',
  ],
};
...
export const TRAIT_ORIGIN_PROSE: Record<string, string[]> = {
  innate: [
    ...
    'There is no origin story for {name}\'s {trait}. People who want one tend to invent it.',
    'The {trait} in {name} predates anything that could have caused it. Asked when it started, {name} has nothing to offer.',
  ],
  mastery: [
    ...
    'The {trait} in {name} looks natural now. The people who watched it being built know better.',
    '{name} can still name the specific failure that taught them the {trait}. They raise it rarely, and never as a story about themselves.',
  ],
  reputation: [
    ...
    'The {trait} attached to {name} before {name} had a chance to object. Objecting now would only confirm it.',
    '{name} has grown into the {trait} that others assigned them. That is a slower process than being born with it and it leaves different marks.',
  ],
  scar: [
    ...
    'The {trait} in {name} has a date attached to it. {name} does not observe it.',
    'Whatever gave {name} the {trait} is not discussed, and the not-discussing has become part of the {trait} itself.',
  ],
  condition: [
    ...
    'The {trait} in {name} is what a long stretch of ordinary pressure leaves behind. No single day is to blame.',
    '{name} developed the {trait} because the alternative did not work where they were standing. It has outlasted the place.',
  ],
  destiny: [
    ...
    'The {trait} arrived in {name} on schedule, though nobody had shown {name} the schedule.',
    '{name} did not choose the {trait} and has stopped calling it a burden. Both things are true and neither is comfortable.',
  ],
};
...
export const TURNING_POINT_PROSE: Record<string, string[]> = {
  mercy_ruthlessness: [
    ...
    'The moment {name} settled on {value} involved someone asking for something {name} could have given. What they did instead is the answer.',
    '{name} arrived at {value} in a room holding a decision that could not be split. They have not been asked to revisit it and would not.',
  ],
  asceticism_extravagance: [
    ...
    'What settled {value} for {name} was an inventory taken at a bad time. The list was shorter than expected, and the relief was the surprise.',
    '{name} chose {value} on a day when the alternative was sitting right there and affordable. The refusal was not difficult, which is what made it informative.',
  ],
  honesty_cunning: [
    ...
    'The turn toward {value} came for {name} in a conversation where the easy answer was available and cheap.',
    '{name} settled {value} by saying the thing that cost them the room. Every room since has been measured against that one.',
  ],
  tradition_novelty: [
    ...
    'The moment {value} settled for {name} involved a practice everyone else was still keeping. {name} stopped, or did not.',
    '{name} committed to {value} in front of people who had assumed the opposite. The correction was not made loudly and was not withdrawn.',
  ],
  loyalty_ambition: [
  ...
  preservation_transformation: [
    ...
    'The moment {value} settled for {name} came with something in front of them that could be kept or remade, and no time to consult anyone.',
    '{name} chose {value} over an outcome that would have been easier to defend afterward. The defence was never needed, which proved nothing either way.',
  ],
  sacrifice_survival: [
    ...
    'The turn toward {value} arrived for {name} with a cost attached and nobody watching to record it.',
    '{name} settled {value} in a moment no longer than any other moment. The size of what it decided became apparent later.',
  ],
  courage_prudence: [
    ...
    'What settled {value} for {name} happened faster than judgement. The judgement caught up and agreed.',
    '{name} arrived at {value} through a decision they were not proud of at the time and have not revised since.',
  ],
};
...
export const CONTRADICTION_PROSE: Record<string, string[]> = {
  mercy_ruthlessness: [
    ...
    '{name} gives the {left_pole} answer and the {right_pole} one in the same week, to people who compare notes afterward.',
    'The {left_pole} in {name} is not a softening of the {right_pole}. They are separate faculties, and which one answers depends on something {name} has never isolated.',
  ],
  asceticism_extravagance: [
    ...
    '{name} keeps the {left_pole} habit and the {right_pole} one in the same house, and neither has agreed to move out.',
    'Ask {name} whether {left_pole} or {right_pole} is really them and you get a straight answer. Ask again a season later and you get the other one, delivered with the same conviction.',
  ],
  honesty_cunning: [
    ...
    '{name} will tell the truth about a small thing to buy room on a larger one. Both the {left_pole} and the {right_pole} are sincere in that moment.',
    'The argument between {left_pole} and {right_pole} in {name} is unresolved because neither side has lost often enough to concede.',
  ],
  tradition_novelty: [
    ...
    '{name} defends the old way to outsiders and dismantles it in private. The {left_pole} and the {right_pole} keep different company.',
    'What the tension between {left_pole} and {right_pole} costs {name} is speed. Every decision gets made twice.',
  ],
  loyalty_ambition: [
    ...
    '{name} has turned down two things they wanted and taken a third they wanted less. {left_pole} and {right_pole} are not keeping score in the same units.',
    'The people closest to {name} have learned not to predict whether {left_pole} or {right_pole} will answer. They have also learned not to ask.',
  ],
  revelation_discretion: [
    ...
    '{name} says the unsayable thing and then guards something trivial for a year. {left_pole} and {right_pole} do not divide by importance.',
    'What the split between {left_pole} and {right_pole} produces in {name} is a reputation for being both the safest and the least safe person to tell things to.',
  ],
  preservation_transformation: [
    ...
    '{name} repairs what should be replaced and replaces what should have been kept. {left_pole} and {right_pole} take turns without consulting each other.',
    'The cost of holding {left_pole} and {right_pole} at equal weight is that {name} is always partway through undoing something they did for good reasons.',
  ],
  sacrifice_survival: [
    ...
    '{name} volunteers and then hedges, in that order, every time. {left_pole} moves first and {right_pole} catches up.',
    'Nobody who has watched {name} choose between {left_pole} and {right_pole} would call either choice out of character. That is the difficulty.',
  ],
  courage_prudence: [
    ...
    '{name} steps forward before the risk is measured and then measures it at length afterward. {left_pole} and {right_pole} are not in sequence so much as in relay.',
    'The {left_pole} in {name} does not overrule the {right_pole}. They alternate, regularly enough that the people close to {name} have learned to wait it out.',
  ],
};
...
export const DECISIVE_NATURE_PROSE: string[] = [
  ...
  '{name} moves through a room the way settled people do — no weight shifted toward a decision still pending, no calculation running visibly behind the eyes. The difference is in the stillness. Clarity, when it is thorough, sits like that: not performed, not maintained, simply present.',
    '{name} answers questions that other people take home with them. The answers do not change on the way back.',
    'Ask {name} what they would give up first and they will tell you, in order, without pausing to assemble the list. It was assembled long ago and at some cost.',
];
...
export const FEAR_PROSE: Record<string, string[]> = {
  ...
  courage_prudence_positive: [
    ...
    '{name} takes the front position without being asked. The {fear} underneath {value} is that someone will notice they were counting on not being tested.',
    'The {fear} {name} carries is not of dying. It is of the moment their {value} is measured against someone whose version of it costs nothing.',
  ],
  courage_prudence_negative: [
    ...
    '{name} has never once been caught unprepared, and the {fear} is what the preparation is for: the belief that their {value} is the only thing between everyone and a bad ending.',
  ...
  sacrifice_survival_positive: [
    ...
    'What {name} will never admit is that the {value} has an audience in mind. The {fear} is of the version with nobody watching.',
    'The {fear} in {name} is not of paying the cost. It is of paying it and learning that {value} did not buy what it was supposed to buy.',
  ],
  sacrifice_survival_negative: [
    ...
    '{name} has stayed alive through things that took other people. The {fear} is that {value} required something they have not yet accounted for.',
    'What {name} will never admit is that the {value} makes a certain arithmetic easy, and that the {fear} is of how quickly they can do it.',
  ],
  // loyalty_ambition
  ...
  loyalty_ambition_negative: [
    ...
    '{name} has not looked back at what the {value} cost. The {fear} is that the accounting exists anyway, and that somebody else is keeping it.',
    'What {name} will never admit is that the {value} has no stopping point built into it. The {fear} is that no amount will read as enough.',
  ],
  // tradition_novelty
  tradition_novelty_positive: [
    ...
    'What {name} will never admit is that the {value} was inherited rather than chosen. The {fear} is that examining it too closely would leave nothing underneath.',
    'The {fear} in {name} is specific: that {value} is not conviction but the shape of the place they came from, worn long enough to feel like a decision.',
  ],
  tradition_novelty_negative: [
    ...
    '{name} moves on before things settle. The {fear} is that {value} is not appetite for the new but an inability to stay long enough to be judged.',
  ...
  asceticism_extravagance_positive: [
    ...
    'What {name} will never admit is that the {value} is a way of owing nobody anything. The {fear} is of the debt that arrives with being given something.',
    'The {fear} underneath {name}\'s {value} is smaller than it looks from outside: that they would not know how to stop, and that everyone would see the not-knowing.',
  ],
  asceticism_extravagance_negative: [
    ...
    '{name} keeps more than they need and gives more than they can spare, and both run on the same {fear} — that {value} is the only thing making them worth having around.',
    'What {name} will never admit is that the {value} is loud on purpose. The {fear} is of what a quiet version of their life would show.',
  ],
  // revelation_discretion
  revelation_discretion_positive: [
    ...
    'What {name} will never admit is that the {value} is easier than the alternative. The {fear} is of the silence they would otherwise have to hold.',
    'The {fear} in {name} is that the {value} has been mistaken for courage, when it has mostly been relief.',
  ],
  revelation_discretion_negative: [
    ...
    '{name} holds things well. The {fear} is that the holding has become the point, and that {value} is now a habit rather than a judgement.',
    'What {name} will never admit is that the {value} has left them alone in a way they did not plan for, and that the {fear} of saying so is part of what keeps it in place.',
  ],
};
...
export const HIDDEN_MOTIVE_PROSE: Record<string, string[]> = {
  'tit-for-tat': [
    ...
    'Put {name} among the decent and they are decent. {strategy_description}, and nobody has yet run the other experiment where {name} could watch the result.',
    'The {strategy_description} in {name} is not a philosophy. It is a rule simple enough to run without supervision, which is exactly why it never gets examined.',
  ],
  grudger: [
    ...
    '{name} has forgiven nobody and would tell you they have never needed to. {strategy_description}, and the list of people who have tested this is short and does not grow.',
    'The {strategy_description} costs {name} more than it protects. They know the arithmetic. They have chosen not to revise the rule, because the rule is the one thing that has never failed them.',
  ],
  pavlov: [
    ...
    'Ask {name} what they believe and you get last season\'s results. {strategy_description}, and the belief updates quietly whenever the results do.',
    'The {strategy_description} makes {name} reliable in one specific way: reliable to the incentives. Change what pays and you have changed {name}, and neither of you will have to discuss it.',
  ],
  'always-cooperate': [
    ...
    '{name} has never once refused a request they could meet. {strategy_description}, and the people asking have stopped noticing that this is unusual.',
    'The {strategy_description} in {name} looks like generosity from outside and functions like a debt from inside. They are the one holding it.',
  ],
  'always-defect': [
    ...
    '{name} has never been surprised by a betrayal. {strategy_description}, and the absence of surprise is the entire return on the position.',
    'The {strategy_description} has cost {name} every relationship that would have required a first move. They count that as evidence.',
  ],
};
...
export const STORY_ARC_PROSE: Record<string, string[]> = {
  tragic_hero: [
    ...
    'The {arc_phase} in {name}\'s thread is not a warning. Warnings imply the option of turning.',
    'What comes for {name} is already in motion and does not need their participation to arrive. The {arc_phase} is only the part that becomes visible.',
  ],
  trickster: [
    ...
    'The {arc_phase} {name} is in ends the way these always end, with an audience discovering it was never the story they thought.',
    'Every version {name} maintains costs a little more to keep. The {arc_phase} is where the cost falls due.',
  ],
  coming_of_age: [
    ...
    '{name} is in the {arc_phase} where the person gets decided, and the deciding does not feel like a decision.',
    'The thread of {name} has not chosen a direction yet. The {arc_phase} is the part where it stops being able to.',
  ],
  brooding_warrior: [
    ...
    'The {arc_phase} for {name} arrives as a demand for the thing they have been carrying, from someone with a right to ask.',
    'What {name} has kept quiet is not gone. The {arc_phase} is where it is given a use.',
  ],
  fallen_noble: [
    ...
    'The {arc_phase} in {name}\'s thread offers a way back up. Threads like this one rarely take it cleanly.',
    'What {name} lost has begun to be worth something again. The {arc_phase} is where that becomes a problem rather than a relief.',
  ],
  true_believer: [
    ...
    'The {arc_phase} for {name} is where the conviction is asked what it costs, and answers.',
    'Nothing in {name} bends. The {arc_phase} is therefore about what breaks instead.',
  ],
  schemer: [
    ...
    'The {arc_phase} in {name}\'s thread is the one they did not plan, arriving on time.',
    '{name} has accounted for every party but one. The {arc_phase} is where that party moves.',
  ],
  wanderer: [
    ...
    'The {arc_phase} for {name} is a place that does not let them leave on schedule.',
    'The thread of {name} has run loose for a long while. The {arc_phase} is where something finally catches on it.',
  ],
  monster: [
    ...
    'The {arc_phase} for {name} is the part where the world decides what it has been living beside.',
    'What {name} is has not changed. The {arc_phase} is only where it stops being deniable.',
  ],
  folk_hero: [
    ...
    'The {arc_phase} in {name}\'s thread is where the story and the person are required to be in the same room.',
    'The songs went ahead of {name} and made promises. The {arc_phase} is where the bill for them arrives.',
  ],
  reluctant_king: [
    ...
    'The {arc_phase} for {name} is where refusing costs more than accepting, and both are still available.',
    'The thread of {name} bends toward a seat they do not want. The {arc_phase} is where nobody else is left to take it.',
  ],
  oathkeeper: [
    ...
    'The {arc_phase} for {name} is the one where two things they promised cannot both be kept.',
    'The thread of {name} has held under everything so far. The {arc_phase} is where the load is chosen rather than accidental.',
  ],
  poisoned_court: [
    ...
    'The {arc_phase} in {name}\'s thread arrives as an offer from someone they have already assessed correctly.',
    'What {name} knows has been an asset. The {arc_phase} is where it becomes the reason they are moved against.',
  ],
  doomed_innocent: [
    ...
    'The {arc_phase} for {name} is the one everyone around them has been quietly working to postpone.',
    'The thread of {name} bends toward a lesson the world teaches only once. The {arc_phase} is the approach to it.',
  ],
  old_power: [
    ...
    'The {arc_phase} for {name} is where the long view stops being an advantage.',
    '{name} has outlasted every previous arrangement. The {arc_phase} is where outlasting stops being the same as prevailing.',
  ],
  kingmaker: [
    ...
    'The {arc_phase} in {name}\'s thread is where the person they placed stops needing them.',
    '{name} has stayed behind the chair for a reason. The {arc_phase} is where standing behind it is no longer cover.',
  ],
  seeker: [
    ...
    'The {arc_phase} for {name} is where the thing they were looking for turns out to have been the wrong shape.',
    'The thread of {name} bends toward an answer. Threads like this one are usually worse off for reaching the {arc_phase} that supplies it.',
  ],
  maker: [
    ...
    'The {arc_phase} for {name} is where something they built gets used for a purpose they did not intend.',
    'The thread of {name} runs through their work rather than their person. The {arc_phase} is where the work outlives the control.',
  ],
  noble_savage: [
    ...
    'The {arc_phase} for {name} is where both worlds ask them to choose and neither will accept a partial answer.',
    'The thread of {name} has been useful precisely because it belonged nowhere. The {arc_phase} is where that stops being permitted.',
  ],
};
...
export const DIVINE_TRANSFORMATION_PROSE: Record<string, string[]> = {
  low: [
    ...
    '{name} has begun to notice the {ascendant_sphere} the way one notices a draught: by its absence when it stops.',
    'Nothing about {name} has visibly changed. The {ascendant_sphere} is present in the small delay before they answer questions they used to answer at once.',
  ],
  medium: [
    ...
    'The {ascendant_sphere} has changed what {name} finds obvious. They no longer remember which conclusions they reached on their own.',
    'People who knew {name} before describe the difference badly and consistently. The {ascendant_sphere} has altered something they can all detect and none of them can name.',
  ],
  high: [
    ...
    'The {ascendant_sphere} decides what {name} notices before {name} has any say in it. The having-no-say does not register as loss.',
    '{name} still makes their own decisions. The {ascendant_sphere} has simply arranged which options are visible when they do.',
  ],
  massive: [
    ...
    'There is no version of {name} left that the {ascendant_sphere} did not write. Asking what they would have wanted otherwise has stopped being a coherent question.',
    '{name} speaks and the {ascendant_sphere} is audible underneath, the way a room is audible under a voice. Neither of them treats this as remarkable anymore.',
  ],
};
