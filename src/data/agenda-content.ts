...
export const AGENDA_TEMPLATES: Record<InterventionType, AgendaTemplate[]> = {
  ...
  persuade: [
    ...
    },
    {
      ...
      name: 'Urge Steadfastness',
      valuePair: 'preservation_transformation',
      valueDirection: 'left',
      narrativeHook: 'the enduring worth of what has been built and must be defended',
      behaviorTag: 'fortress-posture',
      reachBoost: { reach: 'iron', bonus: 0.2 },
      archetypeAffinities: ['conqueror', 'zealot_prophet', 'reluctant_leader'],
    },
  ],
  deceive: [
    {
  ...
  intimidate: [
    {
      ...
      name: 'Shatter Convention',
      valuePair: 'preservation_transformation',
      valueDirection: 'right',
      narrativeHook: 'the forge-heat of divine force that melts old forms into something new',
      behaviorTag: 'forge-posture',
  ...
  afflict_bless: [
    ...
    {
      id: 'bless_charisma',
      name: 'Mantle of Guardianship',
      valuePair: 'preservation_transformation',
      valueDirection: 'left',
      narrativeHook: 'the weight of custodianship — what has been inherited must be protected',
      behaviorTag: 'guardian-blessed',
      reachBoost: { reach: 'heart', bonus: 0.3 },
