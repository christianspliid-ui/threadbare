...
export const WORLD_OBJECT_KINDS: readonly WorldObjectKind[] = [
  ...
  K({
    ...
    owningSystem: 'World Generation, Terrain & Places', writers: ['terrain'], status: 'live',
  ...
  K({
    ...
    owningSystem: 'World Generation, Terrain & Places', writers: ['sublocation', 'strategicGraphOps', 'settlementGenome/materialize'], status: 'live',
  ...
  K({
    ...
    owningSystem: 'Ascendant Beats & Progression', writers: ['gameInit'], status: 'live',
  ...
  K({
    ...
    owningSystem: 'Ascendant Beats & Progression', writers: [], status: 'dormant',
  ...
  K({
    ...
    owningSystem: 'World Generation, Terrain & Places', writers: [], status: 'legacy',
