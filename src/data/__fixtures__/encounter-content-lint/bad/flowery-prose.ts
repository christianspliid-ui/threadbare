...
// R5 trigger: prose + aftermath together contain ≥ 3 flagged phrases (warning, not error).
const contract: EncounterContract = {
  encounter: {
    id: 'encounter.fixture.bad_flowery_prose',
    ...
    beats: [
      {
        ...
        prose:
          'The inexorable weaver of threads draws a gossamer line across the room, ineffable and shimmering.',
        prose_tooltips: {},
        encounter_choices: [
          {
            reach: 'iron',
