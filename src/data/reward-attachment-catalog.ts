...
export const REWARD_POSSESSIONS: GraphNode[] = [
  ...
  // --- Diverse Arms (pipeline: 2026-04-07) ---
  {
    ...
    properties: {
      ...
      subcategory: 'arms',
      tier: 1,
      tags: ['#shadow', '#weapon', '#melee', '#stealth'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'arms',
      tier: 1,
      tags: ['#eye', '#weapon', '#ranged', '#precision', '#combat'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'arms',
      tier: 1,
      tags: ['#stone', '#weapon', '#melee', '#combat'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'arms',
      tier: 2,
      tags: ['#stone', '#iron', '#weapon', '#melee', '#combat', '#ancient'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'tomes_scrolls',
      tier: 1,
      tags: ['#gold', '#scroll', '#social', '#patronage'],
  ...
  // ─── Mounts & Beasts (T1 ×3) ────────────────────────────────────────
  {
    ...
    properties: {
      ...
      tier: 1,
      tags: ['#gold', '#beast', '#mount', '#travel', '#wilderness'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'mounts_beasts',
      tier: 1,
      tags: ['#stone', '#beast', '#travel', '#survival', '#wilderness'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'mounts_beasts',
      tier: 3,
      tags: ['#beast', '#mount', '#shadow', '#combat'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'mounts_beasts',
      tier: 2,
      tags: ['#beast', '#mount', '#veil', '#mystical'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'mounts_beasts',
      tier: 3,
      tags: ['#beast', '#mount', '#heart', '#social', '#healing'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'mounts_beasts',
      tier: 4,
      tags: ['#beast', '#mount', '#star', '#veil', '#legendary'],
  ...
  // ─── Provisions (T1 ×4) ─────────────────────────────────────────────
  {
    ...
    properties: {
      ...
      tier: 1,
      tags: ['#iron', '#provision', '#survival', '#wilderness', '#trade'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 1,
      tags: ['#iron', '#provision', '#survival', '#wilderness'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 1,
      tags: ['#stone', '#tool', '#provision', '#survival', '#wilderness'],
  ...
  // ─── Provisions (T2 ×2) ─────────────────────────────────────────────
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 2,
      tags: ['#provision', '#heart', '#healing', '#wilderness'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 1,
      tags: ['#stone', '#flesh', '#consumable', '#healing', '#life'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'tomes_scrolls',
      tier: 2,
      tags: ['#veil', '#scroll', '#ward', '#entropy', '#arcane'],
  ...
  // --- Tomes & Scrolls (T2 x1) -------------------------------------------
  {
    ...
    properties: {
      ...
      subcategory: 'tomes_scrolls',
      tier: 2,
      tags: ['#veil', '#stone', '#tome', '#ward', '#arcane'],
  ...
  // --- T4 Legendary Provisions (pipeline: 2026-04-07) ---
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 4,
      tags: ['#star', '#heart', '#provision', '#divine', '#ancient', '#healing'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 4,
      tags: ['#iron', '#stone', '#provision', '#ancient', '#cursed', '#survival'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'provisions',
      tier: 4,
      tags: ['#veil', '#shadow', '#provision', '#cursed', '#arcane', '#ancient'],
  ...
  // --- Thin Primitives: Relics (pipeline: 2026-04-07) ---
  {
    ...
    properties: {
      ...
      subcategory: 'relics_talismans',
      tier: 2,
      tags: ['#star', '#relic', '#divine', '#restoration'],
  ...
  // --- Thin Primitives: Tools (pipeline: 2026-04-07) ---
  {
    ...
    properties: {
      ...
      subcategory: 'tools_instruments',
      tier: 1,
      tags: ['#iron', '#tool', '#equipment', '#carrying', '#combat'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'tools_instruments',
      tier: 1,
      tags: ['#veil', '#tool', '#equipment', '#carrying', '#knowledge'],
  ...
  },
  {
    ...
    properties: {
      ...
      subcategory: 'tools_instruments',
      tier: 2,
      tags: ['#stone', '#tool', '#discovery', '#wilderness'],
  ...
  },
  {
    ...
    properties: {
      ...
      slotTag: 'utility',
      tier: 2,
      tags: ['#heart', '#star', '#divine', '#discovery'],
...
export const REWARD_CONDITIONS: GraphNode[] = [
  ...
  // ─── Diseases (T1 ×2) ───────────────────────────────────────────────
  {
    ...
    properties: {
      subcategory: 'condition',
      tier: 1,
      tags: ['#iron', '#disease', '#flesh', '#wilderness', '#negative'],
  ...
  },
  {
    ...
    properties: {
      subcategory: 'condition',
      tier: 2,
      tags: ['#blessing', '#veil', '#temporal', '#positive'],
  ...
  // --- Blessings (T1 x1) -------------------------------------------------
  {
    ...
    properties: {
      subcategory: 'condition',
      tier: 1,
      tags: ['#blessing', '#star', '#fate', '#positive'],
