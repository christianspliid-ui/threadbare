...
export type GraphOpType =
  ...
  | 'advance_artifact_tier' // THR-996: advance an artifact one attachment tier (Mundane→Storied→Mythic→Legendary), scaling its stat_contribution effects — the production caller for advanceAttachmentTier
