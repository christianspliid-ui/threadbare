...
const GOLDEN: Golden = {
  'mortal/easy/local/s1': {
    ...
    probability: 0.92664, roll: 63, capability: 0.401312,
  ...
  'mortal/easy/local/s2': {
    outcome: 'success', rawOutcome: 'success',
    probability: 0.92664, roll: 74, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/mid/local/s3': {
    ...
    probability: 0.55164, roll: 73, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/mid/local/s4': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.55164, roll: 93, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/hard/local/s5': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.17664, roll: 69, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/hard/local/s6': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.17664, roll: 53, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/incapable/local/s7': {
    ...
    probability: 0.05, roll: 2, capability: 0.167982,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  ...
  'mortal/incapable/cosmic/s8': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.05, roll: 16, capability: 0.167982,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/capable/local/s9': {
    outcome: 'success', rawOutcome: 'success',
    probability: 0.95, roll: 20, capability: 0.689974,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/capable/local/s10': {
    outcome: 'success', rawOutcome: 'success',
    probability: 0.95, roll: 51, capability: 0.689974,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/funded/hard/s11': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.062532, roll: 52, capability: 0.310026,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/funded/hard/s12': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.062532, roll: 29, capability: 0.310026,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/funded/mid/s13': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.437532, roll: 57, capability: 0.310026,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  ...
  'player/mid/regional/s16': {
    outcome: 'success_at_cost', rawOutcome: 'success_at_cost',
    probability: 0.108488, roll: 64, capability: 0.14679,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  ...
  'mortal/crit-success/s21': {
    ...
    probability: 0.55164, roll: 44, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/crit-success/s65': {
    outcome: 'critical_success', rawOutcome: 'critical_success',
    probability: 0.55164, roll: 11, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/crit-failure/s67': {
    ...
    probability: 0.55164, roll: 99, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/crit-failure/s143': {
    outcome: 'critical_failure', rawOutcome: 'critical_failure',
    probability: 0.55164, roll: 88, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'mortal/near-miss/s1': {
    outcome: 'failure', rawOutcome: 'failure',
    probability: 0.55164, roll: 63, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  ...
  'push/funded/s21': {
    outcome: 'critical_failure', rawOutcome: 'critical_failure',
    probability: 0.439344, roll: 44, capability: 0.231475,
  ...
  'push/unfunded/s21': {
    outcome: 'critical_failure', rawOutcome: 'critical_failure',
    probability: 0.339344, roll: 44, capability: 0.231475,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'push/funded/s67': {
    outcome: 'critical_failure', rawOutcome: 'critical_failure',
    probability: 0.439344, roll: 99, capability: 0.231475,
    pushAttempted: true, pushCost: 0.05,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  'push/below-gate/s21': {
    outcome: 'critical_success', rawOutcome: 'critical_success',
    probability: 0.651844, roll: 44, capability: 0.231475,
    pushAttempted: false, pushCost: 0,
    resistAttempted: false, resistSucceeded: false, resistCost: 0,
    preResistOutcome: undefined, opCount: 1,
  },
  ...
  'resist/check-fails/s142': {
    outcome: 'critical_failure', rawOutcome: 'critical_failure',
    probability: 0.55164, roll: 66, capability: 0.401312,
    pushAttempted: false, pushCost: 0,
