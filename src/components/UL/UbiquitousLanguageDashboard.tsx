...
export default function UbiquitousLanguageDashboard() {
  ...
  return (
    ...
    >
      ...
      >
        {/* No build timestamp: the snapshot is regenerated by `prebuild` on every
            build, and a wall-clock field made the artifact conflict on every
            cascade merge (THR-714). Schema + term count identify it instead. */}
        <span>
          Schema v{ULData.schemaVersion} · {TERMS.length} terms
        </span>
        <span>•</span>
