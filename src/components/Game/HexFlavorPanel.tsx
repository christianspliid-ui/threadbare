...
const TERRAIN_FLAVOR: Record<string, string> = {
  ...
  deciduous_forest: 'Broad-leafed canopy shifts from emerald to gold with the turning seasons. Ancient paths thread between gnarled trunks.',
  dense_forest: 'The canopy swallows all light. In the perpetual twilight below, strange things grow and stranger things watch.',
  taiga: 'Evergreens stand sentinel in frozen silence. The air tastes of pine and coming snow.',
  ...
  bog: 'Spongy ground gives way without warning. Mist clings to the hollows, and the dead are preserved perfectly in the peat.',
  ...
  volcanic: 'The earth here is restless. Fumaroles hiss, hot springs bubble, and the ground shakes with subterranean fury.',
