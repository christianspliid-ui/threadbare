...
export const TERRAIN_TEXTURE_LAB_VIGNETTE_CONSTANTS = {
  ...
  // Phase 5: Priority & LOD constants
  PRIORITY_MAX_FILLER_CHUNKS: 8,
  PRIORITY_LANDMARK_WEIGHT: 2.0,
  PRIORITY_DISTANCE_FALLOFF: 0.85,
  LOD_SHADER_OCTAVE_COUNT_FULL: 5,
  LOD_SHADER_OCTAVE_COUNT_REDUCED: 3,
  // Phase 4: Interaction constants
  HOVER_MIX_TARGET: 0.45,
  SELECTION_MIX_TARGET: 0.9,
  HOVER_MIX_EASE_MS: 120,
  SELECTION_MIX_EASE_MS: 160,
  CLICK_DEBUG_SPHERE_OPACITY: 0.55,
  RAYCASTER_LANDMARK_RECURSIVE: false,
  LANDMARK_HOVER_CURSOR: 'pointer',
} as const;
