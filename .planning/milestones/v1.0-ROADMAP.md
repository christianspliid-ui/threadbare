...
Plans:
- [x] 12.1-01-PLAN.md — Wire army/battle data into GameView + HexV2View
- [x] 12.1-02-PLAN.md — Conflict event colors + ArmiesTab Tailwind refactor + destruction log
...
Plans:
- [x] m2.5-01-PLAN.md — Monster types, lair graph model, faction definitions, worldgen lair seeding
- [x] m2.5-02-PLAN.md — Lair escalation orchestrator phase, sphere feedback, monster faction creation
- [x] m2.5-03-PLAN.md — Monster encounter templates, army attrition in monster territory
- [x] m2.5-04-PLAN.md — Lair icons on hex map, HexSidebar lair details, ArmiesTab monster faction filter
