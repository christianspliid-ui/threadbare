...
247 UI components · 548 library files · 42 middleware layers · 15 environment variables

**UI:** 247 components (react) — see [ui.md](./ui.md)

**Libraries:** 548 files — see [libraries.md](./libraries.md)
...
- `REVIEW_SIGTERM_GRACE_SEC` — `scripts\review\wrapper.ts`
- _...1 more_
