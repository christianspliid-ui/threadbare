...
- `src\types\unifiedAction.ts` — imported by **189** files
...
- `src\types\encounter.ts` — imported by **88** files
- `src\lib\hexMath.ts` — imported by **60** files
- `src\engine\simulationRuntime.ts` — imported by **59** files
- `src\types\trace.ts` — imported by **58** files
- `src\types\faction.ts` — imported by **57** files
- `src\types\disposition.ts` — imported by **49** files
...
- `src\types\unifiedAction.ts` ← `scripts\cli.ts`, `src\components\Game\ActionDrawer.tsx`, `src\components\Game\ActionDrawer.tsx`, `src\components\Game\ascendant-bar\selectors.ts`, `src\components\Game\debug\DebugTabContent.tsx` +184 more
...
- `src\types\encounter.ts` ← `src\components\Game\debug\DebugTabContent.tsx`, `src\components\Game\debug\EncounterCacheView.tsx`, `src\components\Game\debug\EncounterCacheView.tsx`, `src\components\Game\DebugPanel.tsx`, `src\components\Game\encounter-stage\adapters\buildSimpleEncounterStageModel.ts` +83 more
