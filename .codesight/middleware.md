...
- merchantStrategicPack — `src\data\strategic-packs\merchantStrategicPack.ts`
...
- strategicActionLifecycle.test — `src\engine\__tests__\strategicActionLifecycle.test.ts`
