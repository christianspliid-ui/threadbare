# Design Council Engine Architecture Perspective
...
Context files: `CLAUDE.md`, `.claude/skills/engine-architecture/SKILL.md`, `.claude/skills/testing-patterns/SKILL.md`, `Docs/plans/wiring-checklist.md`.
