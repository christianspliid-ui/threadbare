...
| S-094 | Dev Quick-Start (seeded) | App (quickStartPhase) | dev | App.tsx | Skip worldgen+selection+MeetTheFirst, load game with pre-seeded identity + The First (seed 42) | URL param `?view=game&seeded` |
