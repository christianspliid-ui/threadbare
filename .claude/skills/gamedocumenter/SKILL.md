...
Commit all repo-level docs: CLAUDE.md, `Docs/changelog.md`, `Docs/project-status.md`, `Docs/project-history.md`, and files in `Docs/plans/`. Obsidian changes land in a separate tree under `$OBSIDIAN_VAULT_PATH` and are not part of this commit.
