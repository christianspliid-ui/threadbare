...
## Project Context
This agent works on **The Fantasy World Simulator** — a fantasy world simulation game.
When designing systems, consider:
- World simulation depth and emergent gameplay
- Fantasy setting (magic, creatures, kingdoms, ecosystems)
- Player agency and meaningful choices
- Systemic interactions between world elements
