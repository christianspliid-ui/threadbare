...
> Category: arms | Slug: fill-diverse-arms | Pass: draft
> Status: **DRAFT**
...
```typescript
{
  id: 'reward_arms_hedge_witchs_wand',
  type: 'artifact',
  name: "Hedge-Witch's Wand",
  properties: {
    subcategory: 'arms',
    tier: 2,
...
```typescript
{
  id: 'reward_arms_captains_war_horn',
  type: 'artifact',
  name: "Captain's War Horn",
  properties: {
    subcategory: 'arms',
    tier: 1,
...
```typescript
{
  id: 'reward_arms_iron_marshals_banner',
  type: 'artifact',
  name: "Iron Marshal's Banner",
  properties: {
    subcategory: 'arms',
    tier: 2,
    tags: ['#heart', '#iron', '#weapon', '#banner', '#command', '#combat'],
...
```typescript
{
  id: 'reward_arms_cartographers_marking_bolt',
  type: 'artifact',
  name: "Cartographer's Marking Bolt",
  properties: {
    subcategory: 'arms',
    tier: 1,
    ...
    flavorText: 'Crossbow quarrels with red-dyed fletching. The cartographer who carried them marked enemy positions, not map edges.',
    effects: [
...
```typescript
{
  ...
  properties: {
    ...
    mechanicalSummary: '+0.05 Eye, +0.02 Iron, rescues near-miss Eye tests (+1 step, within 2 margin), +1 awareness range',
    lossCondition: 'breakable',
...
| 3 | Hedge-Witch's Wand | Veil | T2 | passive, conditional, reactive | 0.10 Veil | breakable | 3 |
| 4 | Captain's War Horn | Heart | T1 | passive, conditional, social_modifier | 0.05 Heart + coop | breakable | 3 |
| 5 | Iron Marshal's Banner | Heart+Iron | T2 | passive, conditional, social_modifier, behavior_weight | 0.08 (Heart+Iron) + utility | stealable | 4 |
| 6 | Cartographer's Marking Bolt | Eye | T1 | passive, range_modifier, consumable_charge | 0.03 Eye + awareness + burst | consumable | 3 |
...
| T2 | 5 | ~0.09 | All under | PASS |
| T3 | 1 | ~0.11 | Under | PASS |
