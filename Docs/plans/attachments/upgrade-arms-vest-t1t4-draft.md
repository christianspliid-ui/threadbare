...
> Slug: upgrade-arms-vest-t1t4 | Pass: draft | Mode: upgrade
...
```typescript
{
  ...
  properties: {
    ...
    mechanicalSummary: '+0.12 Iron, -0.05 Heart, when damaged: +0.05 Iron burst decaying over 6 ticks, grants dark_ferocity trait',
...
```typescript
{
  ...
  properties: {
    ...
    mechanicalSummary: '+0.18 Iron, +0.08 Shadow, in combat: blocks fear/intimidation conditions, when attacked: 20% faster movement for 6 ticks (12-tick cooldown), shadow focus persists until combat ends (+0.02 Shadow)',
    lossCondition: 'permanent',
...
```typescript
{
  ...
  properties: {
    ...
    mechanicalSummary: '+0.12 Shadow, -0.06 Heart, entering new hex: +0.04 Shadow burst decaying over 4 ticks, amplifies shadow encounter desire x1.5',
    lossCondition: 'cursed',
...
```typescript
{
  ...
  properties: {
    ...
    mechanicalSummary: '+0.15 Star, +0.08 Veil, in mystical contexts: +0.03 Star, blocks curse/corruption conditions, when damaged: +0.04 Veil ward for 6 ticks (12-tick cooldown)',
    lossCondition: 'permanent',
