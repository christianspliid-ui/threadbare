...
> Category: possessions | Slug: fill-thin-primitives | Pass: revised
...
| Subcategories | relics_talismans (3), tools_instruments (5), provisions (2), tomes_scrolls (2) |
...
| # | Item | Change | Reason |
|---|------|--------|--------|
| 1 | Spring Water Vial | Reordered mechanical summary | Persistent conditional should lead; one-shot trails |
| 2 | Prayer Focus | Renamed to "River Clay Bead" | "Prayer Focus" is generic devotional-RPG; flavor text already describes a thumb-worn clay bead |
| 3 | Essence Siphon | Renamed to "Tarnished Draw-Tube" | "Essence" is a game resource name; item name should describe the physical object |
| 5 | Quintessence Crucible | Renamed to "The Sweating Vessel"; revised summary | "Quintessence" is a game resource name; "Crucible" collides with Alchemist's Crucible; summary misrepresented decay as flat passive |
| 9 | Bag of Conveyance | Revised flavor text; changed subcategory to tools_instruments | Flavor text used meta-narrative wink ("This is not a metaphor"); a bag is not a tome |
| 11 | Tithe Box | Revised summary | Summary omitted third content_grant option (Fortune-Kissed) |
| -- | Batch Summary | Corrected subcategory counts and CONTENT_GRANT section header | Subcategory counts shifted after Bag move; section header falsely included Bag in content_grant count |
...
// ─── Relics & Talismans (T3 x1) ──────────────────────────────────
{
  ...
  properties: {
    ...
    mechanicalSummary: 'Veil bonus decays from +0.08 to +0.02 over time, -0.04 Star, restores 2 quintessence per tick',
...
| 5 | River Clay Bead | `reward_relics_talismans_river_clay_bead` | T2 | relics_talismans | resource_manipulate | passive | 2 | Star | ~0.06 |
| 6 | Tarnished Draw-Tube | `reward_relics_talismans_tarnished_draw_tube` | T2 | relics_talismans | resource_manipulate | tradeoff | 2 | Veil | ~0.07 |
...
| 11 | The Sweating Vessel | `reward_relics_talismans_the_sweating_vessel` | T3 | relics_talismans | resource_manipulate | decay, passive | 3 | Veil | ~0.10 |
| 12 | Bag of Conveyance | `reward_tools_instruments_bag_of_conveyance` | T3 | tools_instruments | slot_bonus (x2), resource_manipulate | passive (x2) | 5 | Gold/Veil | ~0.12 |

### Primitive Coverage

| Primitive | Pre-batch usages | New usages | Post-batch total |
|-----------|-----------------|------------|------------------|
| `resource_manipulate` | 1 (Miser's Mark) | 7 (Spring Water Vial, River Clay Bead, Tarnished Draw-Tube, Meditation Stones, The Sweating Vessel, Bag of Conveyance, Tithe Box) | 8 |
...
| Reach | Count |
|-------|-------|
| Star | 3 (Spring Water Vial, Meditation Stones, River Clay Bead) |
| Veil | 2 (Tarnished Draw-Tube, Scroll Case) |
...
| River Clay Bead (T2) | 2 | 0.04 + conditional resource | Yes (T2: 0.05-0.08) |
| Tarnished Draw-Tube (T2) | 2 | 0.06-0.03 net + drain | Yes |
...
| The Sweating Vessel (T3) | 3 | 0.08 decay - 0.04 + 2q/tick | Yes (T3: 0.08-0.12) |
