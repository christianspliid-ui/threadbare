...
UI note: THR-562 ships the **emergent-trait row + becoming notification** (the "who they are" layer). The fuller layered personality section — "who they were born" (origin vignettes) / "what marked them" (formative marks) as their own tooltip-rich rows — remains **THR-532** (later wave).
