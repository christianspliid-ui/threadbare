...
**Declared, not yet reached:** an unbound `opponentRef`, a self-target or a deceased opponent currently rolls against `FIGHT_DEFAULT_CARD` with `opponentStatus` recorded on the trace. FB2 (THR-1538) routes all three through the no-roll end.
