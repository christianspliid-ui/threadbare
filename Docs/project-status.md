...
**Latest implementation:** Agent zoom tiers & ring token overhaul (2026-03-25) — Restructured zoom tier thresholds (HERO_LOCAL k=5, MAX_ZOOM k=15), shrunk ring tokens to radius 1.5, unified sprite positions across tiers to eliminate position-jump, fixed location ring radius, added live zoom debug info.
