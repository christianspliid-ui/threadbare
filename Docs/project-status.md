...
**Latest:** Wealth resolver complete (2026-03-17) — `wealthResolver` reads actor wealth property, maps to WealthTier, emits Threadbare-aesthetic prose fragments via WEALTH_PROSE table (3–4 fragments × 5 tiers: Magnate/Wealthy/Comfortable/Getting by/Destitute). New `'economic'` ProseCategory (PROSE_CATEGORIES 5→6) gives wealth its own composition slot. Priority 65 (after identity/culture, before faction/disposition). Fail-soft: missing wealth → skip. 4,651 tests pass.
