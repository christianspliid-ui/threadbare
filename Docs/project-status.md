...
The Ready-for-Dev queue holds THR-722 (retire dead `grants[]`), THR-726 (world-minted ambitions), THR-727 (divine receipt). The hourly `tb-opus-pickup` lane and `keep-work-flowing-cc` briefing are live; new work flows through Linear (Threadbare team).
