...
**Latest:** UI Primitives library complete (2026-03-17) — 7 shared components built with 73 tests: SectionHeading, Button, IconButton, ListRow, Card, Modal, Dropdown. Full spec in `Docs/design-system/primitives.md`. `frontend-ui` skill updated. Ready for adoption across existing components.
