...
**Latest implementation:** V1 agent dot behavior restored (2026-03-24) — Agents show as small colored dots at regional zoom, portraits only at hero-local. Bezier hops animate from ring slot to ring slot. Eye icons correctly zoom to agent locations.
