...
- **Other hits:** `src/engine/decisionBoard.ts`, `src/engine/encounter.ts`, `src/engine/fights/fightState.ts`, `src/engine/fights/opposedRoll.ts`, `src/engine/meetingEncounter.ts` +3 more
