...
- **Production hits:** 139 total — 1 write, 2 read, 136 unclassified
...
- **Other hits:** `src/components/CMS/registry.ts`, `src/components/CMS/tunableConstants.ts`, `src/components/Game/ActionDrawer.tsx`, `src/components/Game/debug/NudgeDesignerTab.tsx`, `src/components/Game/debug/TraceFeed.tsx` +131 more
...
- **Producer → Consumer:** Companies & Group Travel → Encounters & Dilemmas
- **UL terms:** *Company*
- **Production hits:** 6 total — 2 write, 2 read, 2 unclassified
...
- **Other hits:** `src/data/content-eval/compositionContract.ts`, `src/types/unifiedAction.ts`
...
- **Producer → Consumer:** Encounters & Dilemmas → Attention, Chronicle & Narrative
- **Production hits:** 186 total — 1 write, 1 read, 184 unclassified
- **Write sites:** `src/engine/playerReceipts.ts`
- **Read sites:** `src/engine/notificationRouter.ts`
- **Other hits:** `src/components/CMS/tunableConstants.ts`, `src/components/Game/ActionCard.tsx`, `src/components/Game/ascendant-bar/IdentityStrip.tsx`, `src/components/Game/ascendant-bar/selectors.ts`, `src/components/Game/ChapterView.tsx` +179 more
- **Verdict:** Tier 2: production writes and reads both present. Not proof of liveness — payloads are unchecked.
