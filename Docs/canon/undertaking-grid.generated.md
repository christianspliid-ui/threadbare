...
- **Destroy × condition** — `cure_condition` — Curing: the removal funnel the expiry phase uses, taken as work — a healer's undertaking. The counter-play to the curse (create × Condition), and since THR-1429 the way a sealed power is freed early.
