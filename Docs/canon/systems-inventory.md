...
| `monsters` (5) | `monsters/isMonster.ts`, `monsters/listMonsters.ts`, `monsters/liveMonster.ts`, `monsters/monsterCard.ts`, `monsters/monsterFelling.ts` | `M1`, `M3`, `THR-1319`, `THR-1544`, `THR-1545`, `THR-1546` |
...
_Counts: 28 registered subsystems (3 dormant) · 101 tick phases · 196 engine domains · 588 modules._
