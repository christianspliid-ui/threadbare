...
| `effects` (11) | `effects/actionTrigger.ts`, `effects/actionTriggerPayloads.ts`, `effects/actorClassification.ts`, `effects/consumableCharges.ts`, `effects/effectEventDispatch.ts`, `effects/effectEvents.ts`, `effects/effectPredicates.ts`, `effects/effectQueries.ts`, `effects/effectWalker.ts`, `effects/index.ts`, `effects/resourceDelta.ts` | `Phase 3`, `Phase 5`, `TB-104`, `THR-1239`, `THR-719` |
...
_Counts: 26 registered subsystems (1 dormant) · 101 tick phases · 172 engine domains · 502 modules._
