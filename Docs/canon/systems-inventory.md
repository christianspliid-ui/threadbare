...
| `fights` (2) | `fights/fightStepInputs.ts`, `fights/opponentCard.ts` | `THR-1264`, `THR-1530`, `THR-1531`, `THR-1535`, `THR-1537` |
...
_Counts: 28 registered subsystems (3 dormant) · 102 tick phases · 194 engine domains · 569 modules._
