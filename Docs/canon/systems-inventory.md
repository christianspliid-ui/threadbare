...
| `undertaking` (4) | `undertakingCheckpoints.ts`, `undertakingMoments.ts`, `undertakingMotive.ts`, `undertakingReviewLevers.ts` | `THR-1281`, `THR-1292`, `THR-1297`, `THR-1299`, `THR-1300` |
...
_Counts: 26 registered subsystems (2 dormant) · 99 tick phases · 180 engine domains · 533 modules._
