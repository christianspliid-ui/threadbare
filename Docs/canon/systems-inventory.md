...
| `6.637` | Unrest | — |
| `6.6385` | Location Traits | `THR-790` |
...
| `6.6385` | Location Traits | `THR-790` | orchestrator |
...
| `clue_rumors` | clue_rumors | — | registry |
...
| `effects` (16) | `effects/actionTrigger.ts`, `effects/actionTriggerPayloads.ts`, `effects/actorClassification.ts`, `effects/conditionApplier.ts`, `effects/conditionProxyEvents.ts`, `effects/consumableCharges.ts`, `effects/effectEventDispatch.ts`, `effects/effectEvents.ts`, `effects/effectOverlayStore.ts`, `effects/effectPredicates.ts`, `effects/effectQueries.ts`, `effects/effectSuppression.ts`, `effects/effectWalker.ts`, `effects/index.ts`, `effects/resourceDelta.ts`, `effects/ruleOverrideConsumers.ts` | `Phase 3`, `Phase 5`, `TB-104`, `THR-1239`, `THR-1240`, `THR-1241`, `THR-1242`, `THR-1244`, `THR-1257`, `THR-1539`, `THR-1542`, `THR-719`, `THR-761` |
...
| `fights` (12) | `fights/fightAdvantages.ts`, `fights/fightAllies.ts`, `fights/fightClock.ts`, `fights/fightEnding.ts`, `fights/fightEvents.ts`, `fights/fightForks.ts`, `fights/fightHarm.ts`, `fights/fightOutcome.ts`, `fights/fightState.ts`, `fights/fightStepInputs.ts`, `fights/opponentCard.ts`, `fights/opposedRoll.ts` | `THR-1261`, `THR-1264`, `THR-1271`, `THR-1530`, `THR-1531`, `THR-1532`, `THR-1535`, `THR-1537`, `THR-1538`, `THR-1539`, `THR-1540`, `THR-1541`, `THR-1543`, `THR-1548`, `THR-1549`, `THR-1556` |
...
| `monsters` (6) | `monsters/isMonster.ts`, `monsters/lairArrivalTrigger.ts`, `monsters/listMonsters.ts`, `monsters/liveMonster.ts`, `monsters/monsterCard.ts`, `monsters/monsterFelling.ts` | `M1`, `M3`, `THR-1267`, `THR-1319`, `THR-1544`, `THR-1545`, `THR-1546`, `THR-1547` |
...
| `realm` (3) | `realmHolder.ts`, `realmProjection.ts`, `realmSeat.ts` | `THR-1155` |
...
| `tooltip` (1) | `tooltipResolver.ts` | `THR-1094`, `THR-1159`, `THR-1172`, `THR-1486`, `THR-1551` |
| `trace` (1) | `traceBuffer.ts` | `THR-1514` |
| `trade` (3) | `tradeRoute.ts`, `tradeRouteMarkers.ts`, `tradeRouteOps.ts` | `Phase 1`, `THR-1188`, `THR-611`, `THR-616`, `THR-670`, `THR-830` |
| `trait` (4) | `traitDefinitionSeeding.ts`, `traitRefIndex.ts`, `traitRefValidation.ts`, `traitShape.ts` | `THR-1394`, `THR-1395`, `THR-1503`, `THR-786`, `THR-809` |
| `traits` (1) | `traits.ts` | `THR-786` |
| `treasure` (1) | `treasureMapConsumption.ts` | — |
| `trust` (1) | `trustMechanics.ts` | — |
| `undertaking` (9) | `undertakingCapabilityGrowth.ts`, `undertakingCatalystAnchor.ts`, `undertakingCheckpoints.ts`, `undertakingDeed.ts`, `undertakingMoments.ts`, `undertakingMotive.ts`, `undertakingProse.ts`, `undertakingResolver.ts`, `undertakingReviewLevers.ts` | `THR-1281`, `THR-1292`, `THR-1297`, `THR-1299`, `THR-1300`, `THR-1392`, `THR-1397`, `THR-1434`, `THR-1440`, `THR-1511` |
...
_Counts: 28 registered subsystems (3 dormant) · 101 tick phases · 196 engine domains · 589 modules._
