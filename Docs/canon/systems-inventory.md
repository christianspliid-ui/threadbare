...
| `fights` (5) | `fights/fightClock.ts`, `fights/fightOutcome.ts`, `fights/fightState.ts`, `fights/fightStepInputs.ts`, `fights/opponentCard.ts` | `THR-1264`, `THR-1530`, `THR-1531`, `THR-1535`, `THR-1537`, `THR-1538` |
...
_Counts: 28 registered subsystems (3 dormant) · 102 tick phases · 194 engine domains · 572 modules._
