...
Christian's interface to the development system is **chat only, plain language only** (settled 2026-07-04, THR-608). Full rationale: [`Docs/plans/2026-07-04-user-review-interface.md`](../plans/2026-07-04-user-review-interface.md). Four hard rules:
