...
See: `agents/consent-round-prompt.md`
### Phase 4 — Synthesis
...
See: `agents/role-prompts/content-iteration.md`
### Engine / architecture perspective
See: `agents/role-prompts/engine-architecture.md`
### Coordination / process perspective
See: `agents/role-prompts/coordination-process.md`
### State-of-the-product perspective (for readiness questions)
See: `agents/role-prompts/state-of-product.md`
## Termination Rules
