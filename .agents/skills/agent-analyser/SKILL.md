...
Read **`report-template.md`** (in this skill directory) for the full markdown scaffold to use when saving analysis to `Docs/analysis/YYYY-MM-DD-encounter-log-analysis-seed<N>.md`.

## Source Code Reference

Read **`source-code-reference.md`** (in this skill directory) for: engine pipeline file map, content template files, constants file, key constants table, and difficulty bands. Load it when diagnosing root causes or writing recommendations that reference specific code locations.
